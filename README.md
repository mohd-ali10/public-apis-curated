...
> A comprehensive, community-curated list of free public APIs for developers, creators, and makers.

## 📖 About
This repository is a manually curated collection of public APIs, maintained by developers like you and the team at [APILayer](https://apilayer.com/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo). Think of it as a treasure trove of well-managed, production-ready endpoints spanning dozens of domains.

💡 **Need a faster way to integrate APIs into your product?**  
...
🌍 **Join our community**  
[💬 Discord Server](https://discord.com/invite/hgjA78638n/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo) | [🛠 Contributing Guide](CONTRIBUTING.md) | [🐛 Issues](https://github.com/public-apis/public-apis/issues) | [📥 Pull Requests](https://github.com/public-apis/public-apis/pulls) | [📜 License](LICENSE)
...
- [💼 Business](#-business)
- [📅 Calendar](#-calendar)
- [☁️ Cloud Storage & File Sharing](#️-cloud-storage--file-sharing)
...
- [📰 News](#-news)
- [🌐 Open Data](#-open-data)
- [🛠️ Open Source Projects](#️-open-source-projects)
- [📜 Patent](#-patent)
...
> 📊 **Table Legend**  
> `Auth`: `No` (No auth required), `apiKey`, `OAuth`, `X-Mashape-Key`, `User-Agent`  
> `HTTPS`: `Yes` / `No`  
> `CORS`: `Yes` / `No` / `Unknown`
...
| :--- | :--- | :---: | :---: | :---: |
| [AdoptAPet](https://www.adoptapet.com/public/apis/pet_list.html) | Resource to help get pets adopted | `apiKey` | ✅ | ✅ |
| [Axolotl](https://theaxolotlapi.netlify.app/) | Collection of axolotl pictures and facts | `No` | ✅ | ❌ |
...
| [Cats](https://docs.thecatapi.com/) | Pictures of cats from Tumblr | `apiKey` | ✅ | ❌ |
| [Dog Facts](https://dukengn.github.io/Dog-facts-API/) | Random dog facts | `No` | ✅ | ✅ |
| [Dog Facts](https://kinduff.github.io/dog-api/) | Random facts of Dogs | `No` | ✅ | ✅ |
| [Dogs](https://dog.ceo/dog-api/) | Based on the Stanford Dogs Dataset | `No` | ✅ | ✅ |
| [eBird](https://documenter.getpostman.com/view/664302/S1ENwy59) | Retrieve recent or notable birding observations within a region | `apiKey` | ✅ | ❌ |
| [FishWatch](https://www.fishwatch.gov/developers) | Information and pictures about individual fish species | `No` | ✅ | ✅ |
| [HTTP Cat](https://http.cat/) | Cat for every HTTP Status | `No` | ✅ | ✅ |
| [HTTP Dog](https://http.dog/) | Dogs for every HTTP response status code | `No` | ✅ | ✅ |
| [IUCN](http://apiv3.iucnredlist.org/api/v3/docs) | IUCN Red List of Threatened Species | `apiKey` | ❌ | ❌ |
| [MeowFacts](https://github.com/wh-iterabb-it/meowfacts) | Get random cat facts | `No` | ✅ | ❌ |
| [Movebank](https://github.com/movebank/movebank-api-doc) | Movement and Migration data of animals | `No` | ✅ | ✅ |
| [Petfinder](https://www.petfinder.com/developers/) | Petfinder is dedicated to helping pets find homes, another resource to get pets adopted | `apiKey` | ✅ | ✅ |
...
| [Shibe.Online](http://shibe.online/) | Random pictures of Shiba Inu, cats or birds | `No` | ✅ | ✅ |
| [The Dog](https://thedogapi.com/) | A public service all about Dogs, free to use when making your fancy new App, Website or Service | `apiKey` | ✅ | ❌ |
| [xeno-canto](https://xeno-canto.org/explore/api) | Bird recordings | `No` | ✅ | `Unknown` |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [AniAPI](https://aniapi.com/docs/) | Anime discovery, streaming & syncing with trackers | `OAuth` | ✅ | ✅ |
| [AniDB](https://wiki.anidb.net/HTTP_API_Definition) | Anime Database | `apiKey` | ❌ | `Unknown` |
...
| [Catboy](https://catboys.com/api) | Neko images, funny GIFs & more | `No` | ✅ | ✅ |
| [Danbooru Anime](https://danbooru.donmai.us/wiki_pages/help:api) | Thousands of anime artist database to find good anime art | `apiKey` | ✅ | ✅ |
| [Jikan](https://jikan.moe) | Unofficial MyAnimeList API | `No` | ✅ | ✅ |
| [Kitsu](https://kitsu.docs.apiary.io/) | Anime discovery platform | `OAuth` | ✅ | ✅ |
| [MangaDex](https://api.mangadex.org/docs.html) | Manga Database and Community | `apiKey` | ✅ | `Unknown` |
...
| [Studio Ghibli](https://ghibliapi.herokuapp.com) | Resources from Studio Ghibli films | `No` | ✅ | ✅ |
| [Trace Moe](https://soruly.github.io/trace.moe-api/#/) | A useful tool to get the exact scene of an anime from a screenshot | `No` | ✅ | ❌ |
| [Waifu.im](https://waifu.im/docs) | Get waifu pictures from an archive of over 4000 images and multiple tags | `No` | ✅ | ✅ |
| [Waifu.pics](https://waifu.pics/docs) | Image sharing platform for anime images | `No` | ✅ | ❌ |
...
| [MalShare](https://malshare.com/doc.php) | Malware Archive / file sourcing | `apiKey` | ✅ | ❌ |
...
| [NoPhishy](https://rapidapi.com/Amiichu/api/exerra-phishing-check/) | Check links to see if they're known phishing attempts | `apiKey` | ✅ | ✅ |
| [Phisherman](https://phisherman.gg/) | IP/domain/URL reputation | `apiKey` | ✅ | `Unknown` |
| [Scanii](https://docs.scanii.com/) | Simple REST API that can scan submitted documents/files for the presence of threats | `apiKey` | ✅ | ✅ |
| [URLhaus](https://urlhaus-api.abuse.ch/) | Bulk queries and Download Malware Samples | `No` | ✅ | ✅ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [Améthyste](https://api.amethyste.moe/) | Generate images for Discord users | `apiKey` | ✅ | `Unknown` |
| [Art Institute of Chicago](https://api.artic.edu/docs/) | Art | `No` | ✅ | ✅ |
...
| [EmojiHub](https://github.com/cheatsnake/emojihub) | Get emojis by categories and groups | `No` | ✅ | ✅ |
...
| [Icon Horse](https://icon.horse) | Favicons for any website, with fallbacks | `No` | ✅ | ✅ |
...
| [Lordicon](https://lordicon.com/) | Icons with predone Animations | `No` | ✅ | ✅ |
| [Metropolitan Museum of Art](https://metmuseum.github.io/) | Met Museum of Art | `No` | ✅ | ❌ |
| [Noun Project](http://api.thenounproject.com/index.html) | Icons | `OAuth` | ❌ | `Unknown` |
| [PHP-Noise](https://php-noise.com/) | Noise Background Image Generator | `No` | ✅ | ✅ |
| [Pixel Encounter](https://pixelencounter.com/api) | SVG Icon Generator | `No` | ✅ | ❌ |
...
| [xColors](https://x-colors.herokuapp.com/) | Generate & convert colors | `No` | ✅ | ✅ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [Auth0](https://auth0.com) | Easy to implement, adaptable authentication and authorization platform | `apiKey` | ✅ | ✅ |
| [GetOTP](https://otp.dev/en/docs/) | Implement OTP flow quickly | `apiKey` | ✅ | ❌ |
| [Micro User Service](https://m3o.com/user) | User management and authentication | `apiKey` | ✅ | ❌ |
| [MojoAuth](https://mojoauth.com) | Secure and modern passwordless authentication platform | `apiKey` | ✅ | ✅ |
| [SAWO Labs](https://sawolabs.com) | Simplify login and improve user experience by integrating passwordless authentication in your app | `apiKey` | ✅ | ✅ |
| [Stytch](https://stytch.com/) | User infrastructure for modern applications | `apiKey` | ✅ | ❌ |
| [Warrant](https://warrant.dev/) | APIs for authorization and access control | `apiKey` | ✅ | ✅ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [Bitquery](https://graphql.bitquery.io/ide) | Onchain GraphQL APIs & DEX APIs | `apiKey` | ✅ | ✅ |
...
| [Etherscan](https://etherscan.io/apis) | Ethereum explorer API | `apiKey` | ✅ | ✅ |
| [Helium](https://docs.helium.com/api/blockchain/introduction/) | Helium is a global, distributed network of Hotspots that create public, long-range wireless coverage | `No` | ✅ | `Unknown` |
| [Nownodes](https://nownodes.io/) | Blockchain-as-a-service solution that provides high-quality connection via API | `apiKey` | ✅ | `Unknown` |
| [Steem](https://developers.steem.io/) | Blockchain-based blogging and social media website | `No` | ❌ | ❌ |
| [The Graph](https://thegraph.com) | Indexing protocol for querying networks like Ethereum with GraphQL | `apiKey` | ✅ | `Unknown` |
| [Walltime](https://walltime.info/api.html) | To retrieve Walltime's market info | `No` | ✅ | `Unknown` |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [A Bíblia Digital](https://www.abibliadigital.com.br/en) | Do not worry about managing the multiple versions of the Bible | `apiKey` | ✅ | ❌ |
| [Bhagavad Gita](https://docs.bhagavadgitaapi.in) | Open Source Shrimad Bhagavad Gita API including 21+ authors translation in Sanskrit/English/Hindi | `apiKey` | ✅ | ✅ |
| [Bhagavad Gita](https://bhagavadgita.io/api) | Bhagavad Gita text | `OAuth` | ✅ | ✅ |
| [Bhagavad Gita telugu](https://gita-api.vercel.app) | Bhagavad Gita API in telugu and odia languages | `No` | ✅ | ✅ |
...
| [Ganjoor](https://api.ganjoor.net) | Classic Persian poetry works including access to related manuscripts, recitations and music tracks | `OAuth` | ✅ | ✅ |
| [Google Books](https://developers.google.com/books/) | Books | `OAuth` | ✅ | `Unknown` |
| [GurbaniNow](https://github.com/GurbaniNow/api) | Fast and Accurate Gurbani RESTful API | `No` | ✅ | `Unknown` |
...
| [Penguin Publishing](http://www.penguinrandomhouse.biz/webservices/rest/) | Books, book covers and related data | `No` | ✅ | ✅ |
| [PoetryDB](https://github.com/thundercomb/poetrydb#readme) | Enables you to get instant data from our vast poetry collection | `No` | ✅ | ✅ |
| [Quran](https://quran.api-docs.io/) | RESTful Quran API with multiple languages | `No` | ✅ | ✅ |
| [Quran Cloud](https://alquran.cloud/api) | A RESTful Quran API to retrieve an Ayah, Surah, Juz or the entire Holy Quran | `No` | ✅ | ✅ |
| [Quran-api](https://github.com/fawazahmed0/quran-api#readme) | Free Quran API Service with 90+ different languages and 400+ translations | `No` | ✅ | ✅ |
| [Rig Veda](https://aninditabasu.github.io/indica/html/rv.html) | Gods and poets, their categories, and the verse meters, with the mandal and sukta number | `No` | ✅ | `Unknown` |
| [The Bible](https://docs.api.bible) | Everything you need from the Bible in one discoverable place | `apiKey` | ✅ | `Unknown` |
| [Thirukkural](https://api-thirukkural.web.app/) | 1330 Thirukkural poems and explanation in Tamil and English | `No` | ✅ | ✅ |
| [Vedic Society](https://aninditabasu.github.io/indica/html/vs.html) | Descriptions of all nouns (names, places, animals, things) from vedic literature | `No` | ✅ | `Unknown` |
| [Wizard World](https://wizard-world-api.herokuapp.com/swagger/index.html) | Get information from the Harry Potter universe | `No` | ✅ | ✅ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [Apache Superset](https://superset.apache.org/docs/api) | API to manage your BI dashboards and data sources on Superset | `apiKey` | ✅ | ✅ |
| [Charity Search](http://charityapi.orghunter.com/) | Non-profit charity data | `apiKey` | ❌ | `Unknown` |
| [Clearbit Logo](https://clearbit.com/docs#logo-api) | Search for company logos and embed them in your projects | `apiKey` | ✅ | `Unknown` |
| [Domainsdb.info](https://domainsdb.info/) | Registered Domain Names Search | `No` | ✅ | ❌ |
...
| [ORB Intelligence](https://api.orb-intelligence.com/docs/) | Company lookup | `apiKey` | ✅ | `Unknown` |
| [Redash](https://redash.io/help/user-guide/integrations-and-api/api) | Access your queries and dashboards on Redash | `apiKey` | ✅ | ✅ |
| [Smartsheet](https://smartsheet.redoc.ly/) | Allows you to programmatically access and Smartsheet data and account information | `OAuth` | ✅ | ❌ |
...
| [Tomba email finder](https://tomba.io/api) | Email Finder for B2B sales and email marketing and email verifier | `apiKey` | ✅ | ✅ |
...
| [Checkiday - National Holiday API](https://apilayer.com/marketplace/checkiday-api) | Industry-leading Holiday API. Over 5,000 holidays and thousands of descriptions. Trusted by the World’s leading companies | `apiKey` | ✅ | `Unknown` |
...
| [Festivo Public Holidays](https://docs.getfestivo.com/docs/products/public-holidays-api/intro) | Fastest and most advanced public holiday and observance service on the market | `apiKey` | ✅ | ✅ |
...
| [Nager.Date](https://date.nager.at) | Public holidays for more than 90 countries | `No` | ✅ | ❌ |
| [Namedays Calendar](https://nameday.abalin.net) | Provides namedays for multiple countries | `No` | ✅ | ✅ |
...
| [Public Holidays](https://www.abstractapi.com/holidays-api) | Data on national, regional, and religious holidays via API | `apiKey` | ✅ | ✅ |
| [Russian Calendar](https://github.com/egno/work-calendar) | Check if a date is a Russian holiday or not | `No` | ✅ | ❌ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [AnonFiles](https://anonfiles.com/docs/api) | Upload and share your files anonymously | `No` | ✅ | `Unknown` |
| [BayFiles](https://bayfiles.com/docs/api) | Upload and share your files | `No` | ✅ | `Unknown` |
...
| [Pantry](https://getpantry.cloud/) | Free JSON storage for small projects | `No` | ✅ | ✅ |
...
| [Quip](https://quip.com/dev/automation/documentation) | File Sharing and Storage for groups | `apiKey` | ✅ | ✅ |
...
| [Web3 Storage](https://web3.storage/) | File Sharing and Storage for Free with 1TB Space | `apiKey` | ✅ | ✅ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [Azure DevOps Health](https://docs.microsoft.com/en-us/rest/api/resourcehealth) | Resource health helps you diagnose and get support when an Azure issue impacts your resources | `apiKey` | ❌ | ❌ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [Coinlayer](https://coinlayer.com?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers) | Real-time Crypto Currency Exchange Rates | `apiKey` | ✅ | `Unknown` |
| [0x](https://0x.org/api) | API for querying token and pool stats across various liquidity pools | `No` | ✅ | ✅ |
| [1inch](https://1inch.io/api/) | API for querying decentralize exchange | `No` | ✅ | `Unknown` |
| [Alchemy Ethereum](https://docs.alchemy.com/alchemy/) | Ethereum Node-as-a-Service Provider | `apiKey` | ✅ | ✅ |
...
| [Bitcambio](https://nova.bitcambio.com.br/api/v3/docs#a-public) | Get the list of all traded assets in the exchange | `No` | ✅ | `Unknown` |
| [BitcoinAverage](https://apiv2.bitcoinaverage.com/) | Digital Asset Price Data for the blockchain industry | `apiKey` | ✅ | `Unknown` |
| [BitcoinCharts](https://bitcoincharts.com/about/exchanges/) | Financial and Technical Data related to the Bitcoin Network | `No` | ✅ | `Unknown` |
...
| [Bittrex](https://bittrex.github.io/api/v3) | Next Generation Crypto Trading Platform | `apiKey` | ✅ | `Unknown` |
...
| [BtcTurk](https://docs.btcturk.com/) | Real-time cryptocurrency data, graphs and API that allows buy &sell | `apiKey` | ✅ | ✅ |
| [Bybit](https://bybit-exchange.github.io/docs/linear/#t-introduction) | Cryptocurrency data feed and algorithmic trading | `apiKey` | ✅ | `Unknown` |
| [CoinAPI](https://docs.coinapi.io/) | All Currency Exchanges integrate under a single api | `apiKey` | ✅ | ❌ |
...
| [CoinDesk](https://old.coindesk.com/coindesk-api/) | CoinDesk's Bitcoin Price Index (BPI) in multiple currencies | `No` | ✅ | `Unknown` |
| [CoinGecko](http://www.coingecko.com/api) | Cryptocurrency Price, Market, and Developer/Social Data | `No` | ✅ | ✅ |
...
| [Coinpaprika](https://api.coinpaprika.com) | Cryptocurrencies prices, volume and more | `No` | ✅ | ✅ |
...
| [CoinStats](https://documenter.getpostman.com/view/5734027/RzZ6Hzr3?version=latest) | Crypto Tracker | `No` | ✅ | `Unknown` |
| [CryptAPI](https://docs.cryptapi.io/) | Cryptocurrency Payment Processor | `No` | ✅ | `Unknown` |
| [CryptingUp](https://www.cryptingup.com/apidoc/#introduction) | Cryptocurrency data | `No` | ✅ | `Unknown` |
| [CryptoCompare](https://www.cryptocompare.com/api#) | Cryptocurrencies Comparison | `No` | ✅ | `Unknown` |
| [CryptoMarket](https://api.exchange.cryptomkt.com/) | Cryptocurrencies Trading platform | `apiKey` | ✅ | ✅ |
| [Cryptonator](https://www.cryptonator.com/api/) | Cryptocurrencies Exchange Rates | `No` | ✅ | `Unknown` |
...
| [FTX](https://docs.ftx.com/) | Complete REST, websocket, and FTX APIs to suit your algorithmic trading needs | `apiKey` | ✅ | ✅ |
...
| [Hirak Exchange Rates](https://rates.hirak.site/) | Exchange rates between 162 currency & 300 crypto currency update each 5 min, accurate, no limits | `apiKey` | ✅ | `Unknown` |
| [Huobi](https://huobiapi.github.io/docs/spot/v1/en/) | Seychelles based cryptocurrency exchange | `apiKey` | ✅ | `Unknown` |
| [icy.tools](https://developers.icy.tools/) | GraphQL based NFT API | `apiKey` | ✅ | `Unknown` |
| [Indodax](https://github.com/btcid/indodax-official-api-docs) | Trade your Bitcoin and other assets with rupiah | `apiKey` | ✅ | `Unknown` |
| [INFURA Ethereum](https://infura.io/product/ethereum) | Interaction with the Ethereum mainnet and several testnets | `apiKey` | ✅ | ✅ |
...
| [Localbitcoins](https://localbitcoins.com/api-docs/) | P2P platform to buy and sell Bitcoins | `No` | ✅ | `Unknown` |
| [Mempool](https://mempool.space/api) | Bitcoin API Service focusing on the transaction fee | `No` | ✅ | ❌ |
| [MercadoBitcoin](https://www.mercadobitcoin.com.br/api-doc/) | Brazilian Cryptocurrency Information | `No` | ✅ | `Unknown` |
| [Messari](https://messari.io/api) | Provides API endpoints for thousands of crypto assets | `No` | ✅ | `Unknown` |
| [Nexchange](https://nexchange2.docs.apiary.io/) | Automated cryptocurrency exchange service | `No` | ❌ | ✅ |
| [Nomics](https://nomics.com/docs/) | Historical and realtime cryptocurrency prices and market data | `apiKey` | ✅ | ✅ |
...
| [OKEx](https://www.okex.com/docs/) | Cryptocurrency exchange based in Seychelles | `apiKey` | ✅ | `Unknown` |
...
| [Technical Analysis](https://technical-analysis-api.com) | Cryptocurrency prices and technical analysis | `apiKey` | ✅ | ❌ |
...
| [ZMOK](https://zmok.io) | Ethereum JSON RPC API and Web3 provider | `No` | ✅ | `Unknown` |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [Currencylayer](https://currencylayer.com?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers) | Exchange rates and currency conversion | `apiKey` | ✅ | `Unknown` |
| [Exchangerate.host](https://exchangerate.host?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers) | Free foreign exchange & crypto rates API | `No` | ✅ | `Unknown` |
| [Exchangeratesapi.io](https://exchangeratesapi.io?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers) | Exchange rates with currency conversion | `apiKey` | ✅ | ✅ |
| [Fixer](https://fixer.io?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers) | Exchange rates and currency conversion | `apiKey` | ❌ | `Unknown` |
...
| [Currency-api](https://github.com/fawazahmed0/currency-api#readme) | Free Currency Exchange Rates API with 150+ Currencies & No Rate Limits | `No` | ✅ | ✅ |
| [CurrencyFreaks](https://currencyfreaks.com/) | Provides current and historical currency exchange rates with free plan 1K requests/month | `apiKey` | ✅ | ✅ |
| [CurrencyScoop](https://currencyscoop.com/api-documentation) | Real-time and historical currency rates JSON API | `apiKey` | ✅ | ✅ |
...
| [ExchangeRate-API](https://www.exchangerate-api.com) | Free currency conversion | `apiKey` | ✅ | ✅ |
| [Frankfurter](https://www.frankfurter.app/docs) | Exchange rates, currency conversion and time series | `No` | ✅ | ✅ |
| [FreeForexAPI](https://freeforexapi.com/Home/Api) | Real-time foreign exchange rates for major currency pairs | `No` | ✅ | ❌ |
| [National Bank of Poland](http://api.nbp.pl/en.html) | A collection of currency exchange rates (data in XML and JSON) | `No` | ✅ | ✅ |
| [VATComply.com](https://www.vatcomply.com/documentation) | Exchange rates, geolocation and VAT number validation | `No` | ✅ | ✅ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [VATlayer](https://vatlayer.com/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers) | VAT number validation | `apiKey` | ✅ | `Unknown` |
...
| [US Autocomplete](https://www.smarty.com/docs/cloud/us-autocomplete-pro-api) | Enter address data quickly with real-time address suggestions | `apiKey` | ✅ | ✅ |
| [US Extract](https://www.smarty.com/products/apis/us-extract-api) | Extract postal addresses from any text including emails | `apiKey` | ✅ | ✅ |
| [US Street Address](https://www.smarty.com/docs/cloud/us-street-api) | Validate and append data for any US postal address | `apiKey` | ✅ | ✅ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [Userstack](https://userstack.com/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers) | Secure User-Agent String Lookup JSON API | `OAuth` | ✅ | `Unknown` |
| [24 Pull Requests](https://24pullrequests.com/api) | Project to promote open source collaboration during December | `No` | ✅ | ✅ |
| [Agify.io](https://agify.io) | Estimates the age from a first name | `No` | ✅ | ✅ |
| [API Grátis](https://apigratis.com.br/) | Multiples services and public APIs | `No` | ✅ | `Unknown` |
| [ApicAgent](https://www.apicagent.com) | Extract device details from user-agent string | `No` | ✅ | ✅ |
...
| [Base](https://www.base-api.io/) | Building quick backends | `apiKey` | ✅ | ✅ |
| [Beeceptor](https://beeceptor.com/) | Build a mock Rest API endpoint in seconds | `No` | ✅ | ✅ |
| [Bitbucket](https://developer.atlassian.com/bitbucket/api/2/reference/) | Bitbucket API | `OAuth` | ✅ | `Unknown` |
| [Blague.xyz](https://blague.xyz/) | La plus grande API de Blagues FR/The biggest FR jokes API | `apiKey` | ✅ | ✅ |
...
| [Bored](https://www.boredapi.com/) | Find random activities to fight boredom | `No` | ✅ | `Unknown` |
| [Brainshop.ai](https://brainshop.ai/) | Make A Free A.I Brain | `apiKey` | ✅ | ✅ |
| [Browshot](https://browshot.com/api/documentation) | Easily make screenshots of web pages in any screen size, as any device | `apiKey` | ✅ | ✅ |
| [CDNJS](https://api.cdnjs.com/libraries/jquery) | Library info on CDNJS | `No` | ✅ | `Unknown` |
| [Changelogs.md](https://changelogs.md) | Structured changelog metadata from open source projects | `No` | ✅ | `Unknown` |
| [Ciprand](https://github.com/polarspetroll/ciprand) | Secure random string generator | `No` | ✅ | ❌ |
| [Cloudflare Trace](https://github.com/fawazahmed0/cloudflare-trace-api) | Get IP Address, Timestamp, User Agent, Country Code, IATA, HTTP Version, TLS/SSL Version & More | `No` | ✅ | ✅ |
| [Codex](https://github.com/Jaagrav/CodeX) | Online Compiler for Various Languages | `No` | ✅ | `Unknown` |
| [Contentful Images](https://www.contentful.com/developers/docs/references/images-api/) | Used to retrieve and apply transformations to images | `apiKey` | ✅ | ✅ |
| [CORS Proxy](https://github.com/burhanuday/cors-proxy) | Get around the dreaded CORS error by using this proxy as a middle man | `No` | ✅ | ✅ |
| [CountAPI](https://countapi.xyz) | Free and simple counting service. You can use it to track page hits and specific events | `No` | ✅ | ✅ |
| [Databricks](https://docs.databricks.com/dev-tools/api/latest/index.html) | Service to manage your databricks account,clusters, notebooks, jobs and workspaces | `apiKey` | ✅ | ✅ |
| [DigitalOcean Status](https://status.digitalocean.com/api) | Status of all DigitalOcean services | `No` | ✅ | `Unknown` |
| [Docker Hub](https://docs.docker.com/docker-hub/api/latest/) | Interact with Docker Hub | `apiKey` | ✅ | ✅ |
...
| [ExtendsClass JSON Storage](https://extendsclass.com/json-storage.html) | A simple JSON store API | `No` | ✅ | ✅ |
| [GeekFlare](https://apidocs.geekflare.com/docs/geekflare-api) | Provide numerous capabilities for important testing and monitoring methods for websites | `apiKey` | ✅ | `Unknown` |
| [Genderize.io](https://genderize.io) | Estimates a gender from a first name | `No` | ✅ | ✅ |
| [GETPing](https://www.getping.info) | Trigger an email notification with a simple GET request | `apiKey` | ✅ | `Unknown` |
| [Ghost](https://ghost.org/) | Get Published content into your Website, App or other embedded media | `apiKey` | ✅ | ✅ |
| [GitHub](https://docs.github.com/en/free-pro-team@latest/rest) | Make use of GitHub repositories, code and user info programmatically | `OAuth` | ✅ | ✅ |
| [Gitlab](https://docs.gitlab.com/ee/api/) | Automate GitLab interaction programmatically | `OAuth` | ✅ | `Unknown` |
| [Gitter](https://developer.gitter.im/docs/welcome) | Chat for Developers | `OAuth` | ✅ | `Unknown` |
| [Glitterly](https://developers.glitterly.app) | Image generation API | `apiKey` | ✅ | ✅ |
...
| [Hasura](https://hasura.io/opensource/) | GraphQL and REST API Engine with built in Authorization | `apiKey` | ✅ | ✅ |
| [Heroku](https://devcenter.heroku.com/articles/platform-api-reference/) | REST API to programmatically create apps, provision add-ons and perform other task on Heroku | `OAuth` | ✅ | ✅ |
| [host-t.com](https://host-t.com) | Basic DNS query via HTTP GET request | `No` | ✅ | ❌ |
| [Host.io](https://host.io) | Domains Data API for Developers | `apiKey` | ✅ | ✅ |
| [HTTP2.Pro](https://http2.pro/doc/api) | Test endpoints for client and server HTTP/2 protocol support | `No` | ✅ | `Unknown` |
| [Httpbin](https://httpbin.org/) | A Simple HTTP Request & Response Service | `No` | ✅ | ✅ |
| [Httpbin Cloudflare](https://cloudflare-quic.com/b/) | A Simple HTTP Request & Response Service with HTTP/3 Support by Cloudflare | `No` | ✅ | ✅ |
...
| [IBM Text to Speech](https://cloud.ibm.com/docs/text-to-speech/getting-started.html) | Convert text to speech | `apiKey` | ✅ | ✅ |
| [Icanhazepoch](https://icanhazepoch.com) | Get Epoch time | `No` | ✅ | ✅ |
...
| [Image-Charts](https://documentation.image-charts.com/) | Generate charts, QR codes and graph images | `No` | ✅ | ✅ |
| [import.io](http://api.docs.import.io/) | Retrieve structured data from a website or RSS feed | `apiKey` | ✅ | `Unknown` |
| [ip-fast.com](https://ip-fast.com/docs/) | IP address, country and city | `No` | ✅ | ✅ |
| [IP2WHOIS Information Lookup](https://www.ip2whois.com/) | WHOIS domain name lookup | `apiKey` | ✅ | `Unknown` |
| [ipfind.io](https://ipfind.io) | Geographic location of an IP address or any domain name along with some other useful information | `apiKey` | ✅ | ✅ |
...
| [jsDelivr](https://github.com/jsdelivr/data.jsdelivr.com) | Package info and download stats on jsDelivr CDN | `No` | ✅ | ✅ |
...
| [JSONbin.io](https://jsonbin.io) | Free JSON storage service. Ideal for small scale Web apps, Websites and Mobile apps | `apiKey` | ✅ | ✅ |
| [Kroki](https://kroki.io) | Creates diagrams from textual descriptions | `No` | ✅ | ✅ |
| [License-API](https://github.com/cmccandless/license-api/blob/master/README.md) | Unofficial REST API for choosealicense.com | `No` | ✅ | ❌ |
| [Logs.to](https://logs.to/) | Generate logs | `apiKey` | ✅ | `Unknown` |
| [Lua Decompiler](https://lua-decompiler.ferib.dev/) | Online Lua 5.1 Decompiler | `No` | ✅ | ✅ |
| [MAC address vendor lookup](https://macaddress.io/api) | Retrieve vendor details and other information regarding a given MAC address or an OUI | `apiKey` | ✅ | ✅ |
| [Micro DB](https://m3o.com/db) | Simple database service | `apiKey` | ✅ | `Unknown` |
| [MicroENV](https://microenv.com/) | Fake Rest API for developers | `No` | ✅ | `Unknown` |
| [Mocky](https://designer.mocky.io/) | Mock user defined test JSON for REST API endpoints | `No` | ✅ | ✅ |
| [MY IP](https://www.myip.com/api-docs/) | Get IP address information | `No` | ✅ | `Unknown` |
| [Nationalize.io](https://nationalize.io) | Estimate the nationality of a first name | `No` | ✅ | ✅ |
| [Netlify](https://docs.netlify.com/api/get-started/) | Netlify is a hosting service for the programmable web | `OAuth` | ✅ | `Unknown` |
| [NetworkCalc](https://networkcalc.com/api/docs) | Network calculators, including subnets, DNS, binary, and security tools | `No` | ✅ | ✅ |
| [npm Registry](https://github.com/npm/registry/blob/master/docs/REGISTRY-API.md) | Query information about your favorite Node.js libraries programatically | `No` | ✅ | `Unknown` |
| [OneSignal](https://documentation.onesignal.com/docs/onesignal-api) | Self-serve customer engagement solution for Push Notifications, Email, SMS & In-App | `apiKey` | ✅ | `Unknown` |
...
| [OpenGraphr](https://opengraphr.com/docs/1.0/overview) | Really simple API to retrieve Open Graph data from an URL | `apiKey` | ✅ | `Unknown` |
| [oyyi](https://oyyi.xyz/docs/1.0) | API for Fake Data, image/video conversion, optimization, pdf optimization and thumbnail generation | `No` | ✅ | ✅ |
| [PageCDN](https://pagecdn.com/docs/public-api) | Public API for javascript, css and font libraries on PageCDN | `apiKey` | ✅ | ✅ |
...
| [ProxyKingdom](https://proxykingdom.com) | Rotating Proxy API that produces a working proxy on every request | `apiKey` | ✅ | ✅ |
| [Pusher Beams](https://pusher.com/beams) | Push notifications for Android & iOS | `apiKey` | ✅ | `Unknown` |
| [QR code](https://www.qrtag.net/api/) | Create an easy to read QR code and URL shortener | `No` | ✅ | ✅ |
| [QR code](http://goqr.me/api/) | Generate and decode / read QR code graphics | `No` | ✅ | `Unknown` |
...
| [QuickChart](https://quickchart.io/) | Generate chart and graph images | `No` | ✅ | ✅ |
| [Random Stuff](https://api-docs.pgamerx.com/) | Can be used to get AI Response, jokes, memes, and much more at lightning-fast speed | `apiKey` | ✅ | ✅ |
| [Rejax](https://rejax.io/) | Reverse AJAX service to notify clients | `apiKey` | ✅ | ❌ |
| [ReqRes](https://reqres.in/) | A hosted REST-API ready to respond to your AJAX requests | `No` | ✅ | `Unknown` |
| [RSS feed to JSON](https://rss-to-json-serverless-api.vercel.app) | Returns RSS feed in JSON format using feed URL | `No` | ✅ | ✅ |
| [SavePage.io](https://www.savepage.io) | A free, RESTful API used to screenshot any desktop, or mobile website | `apiKey` | ✅ | ✅ |
...
| [scraperBox](https://scraperbox.com/) | Undetectable web scraping API | `apiKey` | ✅ | ✅ |
| [scrapestack](https://scrapestack.com/) | Real-time, Scalable Proxy & Web Scraping REST API | `apiKey` | ✅ | `Unknown` |
...
| [Screenshot](https://www.abstractapi.com/website-screenshot-api) | Take programmatic screenshots of web pages from any website | `apiKey` | ✅ | ✅ |
| [ScreenshotAPI.net](https://screenshotapi.net/) | Create pixel-perfect website screenshots | `apiKey` | ✅ | ✅ |
| [Serialif Color](https://color.serialif.com/) | Color conversion, complementary, grayscale and contrasted text | `No` | ✅ | ❌ |
| [serpstack](https://serpstack.com/) | Real-Time & Accurate Google Search Results API | `apiKey` | ✅ | ✅ |
...
| [Sonar](https://github.com/Cgboal/SonarSearch) | Project Sonar DNS Enumeration API | `No` | ✅ | ✅ |
...
| [Statically](https://statically.io/) | A free CDN for developers | `No` | ✅ | ✅ |
| [Supportivekoala](https://developers.supportivekoala.com/) | Autogenerate images with template | `apiKey` | ✅ | ✅ |
| [Tyk](https://tyk.io/open-source/) | Api and service management platform | `apiKey` | ✅ | ✅ |
| [Wandbox](https://github.com/melpon/wandbox/blob/master/kennel2/API.rst) | Code compiler supporting 35+ languages mentioned at wandbox.org | `No` | ✅ | `Unknown` |
| [WebScraping.AI](https://webscraping.ai/) | Web Scraping API with built-in proxies and JS rendering | `apiKey` | ✅ | ✅ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [Chinese Character Web](http://ccdb.hemiola.com/) | Chinese character definitions and pronunciations | `No` | ❌ | ❌ |
...
| [Indonesia Dictionary](https://new-kbbi-api.herokuapp.com/) | Indonesia dictionary many words | `No` | ✅ | `Unknown` |
| [Lingua Robot](https://www.linguarobot.io) | Word definitions, pronunciations, synonyms, antonyms and others | `apiKey` | ✅ | ✅ |
| [Merriam-Webster](https://dictionaryapi.com/) | Dictionary and Thesaurus Data | `apiKey` | ✅ | `Unknown` |
| [OwlBot](https://owlbot.info/) | Definitions with example sentence and photo if available | `apiKey` | ✅ | ✅ |
| [Oxford](https://developer.oxforddictionaries.com/) | Dictionary Data | `apiKey` | ✅ | ❌ |
...
| [Wiktionary](https://en.wiktionary.org/w/api.php) | Collaborative dictionary data | `No` | ✅ | ✅ |
...
| [apilayer pdflayer](https://pdflayer.com) | HTML/URL to PDF | `apiKey` | ✅ | `Unknown` |
| [Asana](https://developers.asana.com/docs) | Programmatic access to all data in your asana system | `apiKey` | ✅ | ✅ |
...
| [Cloudmersive Document and Data Conversion](https://cloudmersive.com/convert-api) | HTML/URL to PDF/PNG, Office documents to PDF, image conversion | `apiKey` | ✅ | ✅ |
| [Code::Stats](https://codestats.net/api-docs) | Automatic time tracking for programmers | `apiKey` | ✅ | ❌ |
| [CraftMyPDF](https://craftmypdf.com) | Generate PDF documents from templates with a drop-and-drop editor and a simple API | `apiKey` | ✅ | ❌ |
...
| [iLovePDF](https://developer.ilovepdf.com/) | Convert, merge, split, extract text and add page numbers for PDFs. Free for 250 documents/month | `apiKey` | ✅ | ✅ |
...
| [Mercury](https://mercury.postlight.com/web-parser/) | Web parser | `apiKey` | ✅ | `Unknown` |
| [Monday](https://api.developer.monday.com/docs) | Programmatically access and update data inside a monday.com account | `apiKey` | ✅ | `Unknown` |
| [Notion](https://developers.notion.com/docs/getting-started) | Integrate with Notion | `OAuth` | ✅ | `Unknown` |
| [PandaDoc](https://developers.pandadoc.com) | DocGen and eSignatures API | `apiKey` | ✅ | ❌ |
...
| [Smart Image Enhancement API](https://apilayer.com/marketplace/image_enhancement-api) | Performs image upscaling by adding detail to images through multiple super-resolution algorithms | `apiKey` | ✅ | `Unknown` |
| [Vector Express v2.0](https://vector.express) | Free vector file converting API | `No` | ✅ | ❌ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [mailboxlayer](https://mailboxlayer.com?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers) | Email address validation | `apiKey` | ✅ | `Unknown` |
| [Cloudmersive Validate](https://cloudmersive.com/validate-api) | Validate email addresses, phone numbers, VAT numbers and domain names | `apiKey` | ✅ | ✅ |
| [Disify](https://www.disify.com/) | Validate and detect disposable and temporary email addresses | `No` | ✅ | ✅ |
| [DropMail](https://dropmail.me/api/#live-demo) | GraphQL API for creating and managing ephemeral e-mail inboxes | `No` | ✅ | `Unknown` |
| [Email Validation](https://www.abstractapi.com/email-verification-validation-api) | Validate email addresses for deliverability and spam | `apiKey` | ✅ | ✅ |
| [EVA](https://eva.pingutil.com/) | Validate email addresses | `No` | ✅ | ✅ |
...
| [Kickbox](https://open.kickbox.com/) | Email verification API | `No` | ✅ | ✅ |
| [mail.gw](https://docs.mail.gw) | 10 Minute Mail | `No` | ✅ | ✅ |
| [mail.tm](https://docs.mail.tm) | Temporary Email Service | `No` | ✅ | ✅ |
...
| [Verifier](https://verifier.meetchopra.com/docs#/) | Verifies that a given email is real | `apiKey` | ✅ | ✅ |
...
| [Corporate Buzz Words](https://github.com/sameerkumar18/corporate-bs-generator-api) | REST API for Corporate Buzz Words | `No` | ✅ | ✅ |
| [Excuser](https://excuser.herokuapp.com/) | Get random excuses for various situations | `No` | ✅ | `Unknown` |
| [Fun Fact](https://api.aakhilv.me) | A simple HTTPS api that can randomly select and return a fact from the FFA database | `No` | ✅ | ✅ |
...
| [NaMoMemes](https://github.com/theIYD/NaMoMemes) | Memes on Narendra Modi | `No` | ✅ | `Unknown` |
...
| [Yo Momma Jokes](https://github.com/beanboi7/yomomma-apiv2) | REST API for Yo Momma Jokes | `No` | ✅ | `Unknown` |
...
| [Carbon Interface](https://docs.carboninterface.com/) | API to calculate carbon (C02) emissions estimates for common C02 emitting activities | `apiKey` | ✅ | ✅ |
| [Climatiq](https://docs.climatiq.io) | Calculate the environmental footprint created by a broad range of emission-generating activities | `apiKey` | ✅ | ✅ |
...
| [CO2 Offset](https://co2offset.io/api.html) | API calculates and validates the carbon footprint | `No` | ✅ | `Unknown` |
| [Danish data service Energi](https://www.energidataservice.dk/) | Open energy data from Energinet to society | `No` | ✅ | `Unknown` |
| [GrünstromIndex](https://gruenstromindex.de/) | Green Power Index for Germany (Grünstromindex/GSI) | `No` | ❌ | ✅ |
...
| [PM25.in](http://www.pm25.in/api_doc) | Air quality of China | `apiKey` | ❌ | `Unknown` |
| [PVWatts](https://developer.nrel.gov/docs/solar/pvwatts/v6/) | Energy production photovoltaic (PV) energy systems | `apiKey` | ✅ | `Unknown` |
| [Srp Energy](https://srpenergy-api-client-python.readthedocs.io/en/latest/api.html) | Hourly usage energy report for Srp customers | `apiKey` | ✅ | ❌ |
...
| [Website Carbon](https://api.websitecarbon.com/) | API to estimate the carbon footprint of loading web pages | `No` | ✅ | `Unknown` |
...
| [Ticketmaster](http://developer.ticketmaster.com/products-and-docs/apis/getting-started/) | Search events, attractions, or venues | `apiKey` | ✅ | `Unknown` |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [Marketstack](https://marketstack.com/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers) | Real-Time, Intraday & Historical Market Data API | `apiKey` | ✅ | `Unknown` |
| [Aletheia](https://aletheiaapi.com/) | Insider trading data, earnings call analysis, financial statements, and more | `apiKey` | ✅ | ✅ |
| [Alpaca](https://alpaca.markets/docs/api-documentation/api-v2/market-data/alpaca-data-api-v2/) | Realtime and historical market data on all US equities and ETFs | `apiKey` | ✅ | ✅ |
| [Alpha Vantage](https://www.alphavantage.co/) | Realtime and historical stock data | `apiKey` | ✅ | `Unknown` |
| [Banco do Brasil](https://developers.bb.com.br/home) | All Banco do Brasil financial transaction APIs | `OAuth` | ✅ | ✅ |
| [Bank Data API](https://apilayer.com/marketplace/bank_data-api) | Instant IBAN and SWIFT number validation across the globe | `apiKey` | ✅ | `Unknown` |
...
| [FRED](https://fred.stlouisfed.org/docs/api/fred/) | Economic data from the Federal Reserve Bank of St. Louis | `apiKey` | ✅ | ✅ |
| [Front Accounting APIs](https://frontaccounting.com/fawiki/index.php?n=Devel.SimpleAPIModule) | Front accounting is multilingual and multicurrency software for small businesses | `OAuth` | ✅ | ✅ |
| [Hotstoks](https://hotstoks.com?utm_source=public-apis) | Stock market data powered by SQL | `apiKey` | ✅ | ✅ |
| [IEX Cloud](https://iexcloud.io/docs/api/) | Realtime & Historical Stock and Market Data | `apiKey` | ✅ | ✅ |
...
| [Nordigen](https://nordigen.com/en/account_information_documenation/integration/quickstart_guide/) | Connect to bank accounts using official bank APIs and get raw transaction data | `apiKey` | ✅ | `Unknown` |
| [OpenFIGI](https://www.openfigi.com/api) | Equity, index, futures, options symbology from Bloomberg LP | `apiKey` | ✅ | ✅ |
| [Plaid](https://www.plaid.com/docs) | Connect with user's bank accounts and access transaction data | `apiKey` | ✅ |  |
...
| [SEC EDGAR Data](https://www.sec.gov/edgar/sec-api-documentation) | API to access annual reports of public US companies | `No` | ✅ | ✅ |
| [SmartAPI](https://smartapi.angelbroking.com/) | Gain access to set of   and create end-to-end broking services | `apiKey` | ✅ | `Unknown` |
| [StockData](https://www.StockData.org) | Real-Time, Intraday & Historical Market Data, News and Sentiment API | `apiKey` | ✅ | ✅ |
| [Styvio](https://www.Styvio.com) | Realtime and historical stock data and current stock sentiment | `apiKey` | ✅ | `Unknown` |
| [Tax Data API](https://apilayer.com/marketplace/tax_data-api) | Instant VAT number and tax validation across the globe | `apiKey` | ✅ | `Unkown` |
| [Tradier](https://developer.tradier.com) | US equity/option market data (delayed, intraday, historical) | `OAuth` | ✅ | ✅ |
| [Twelve Data](https://twelvedata.com/) | Stock market data (real-time & historical) | `apiKey` | ✅ | `Unknown` |
| [VAT Validation](https://www.abstractapi.com/vat-validation-rates-api) | Validate VAT numbers and calculate VAT rates | `apiKey` | ✅ | ✅ |
| [WallstreetBets](https://dashboard.nbshare.io/apps/reddit/api/) | WallstreetBets Stock Comments Sentiment Analysis | `No` | ✅ | `Unknown` |
| [Yahoo Finance](https://www.yahoofinanceapi.com/) | Real time low latency Yahoo Finance API for stock market, crypto currencies, and currency exchange | `apiKey` | ✅ | ✅ |
| [YNAB](https://api.youneedabudget.com/) | Budgeting & Planning | `OAuth` | ✅ | ✅ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [BaconMockup](https://baconmockup.com/) | Resizable bacon placeholder images | `No` | ✅ | ✅ |
...
| [Foodish](https://github.com/surhud004/Foodish#readme) | Random pictures of food dishes | `No` | ✅ | ✅ |
| [Fruityvice](https://www.fruityvice.com) | Data about all kinds of fruit | `No` | ✅ | `Unknown` |
| [Kroger](https://developer.kroger.com/reference) | Supermarket Data | `apiKey` | ✅ | `Unknown` |
| [LCBO](https://lcboapi.com/) | Alcohol | `apiKey` | ✅ | `Unknown` |
| [Open Brewery DB](https://www.openbrewerydb.org) | Breweries, Cideries and Craft Beer Bottle Shops | `No` | ✅ | ✅ |
| [Open Food Facts](https://world.openfoodfacts.org/data) | Food Products Database | `No` | ✅ | `Unknown` |
| [PunkAPI](https://punkapi.com/) | Brewdog Beer Recipes | `No` | ✅ | `Unknown` |
| [Rustybeer](https://rustybeer.herokuapp.com/) | Beer brewing tools | `No` | ✅ | ❌ |
| [Spoonacular](https://spoonacular.com/food-api) | Recipes, Food Products, and Meal Planning | `apiKey` | ✅ | `Unknown` |
| [Systembolaget](https://api-portal.systembolaget.se) | Govornment owned liqour store in Sweden | `apiKey` | ✅ | `Unknown` |
...
| [TheCocktailDB](https://www.thecocktaildb.com/api.php) | Cocktail Recipes | `apiKey` | ✅ | ✅ |
| [TheMealDB](https://www.themealdb.com/api.php) | Meal Recipes | `apiKey` | ✅ | ✅ |
| [Untappd](https://untappd.com/api/docs) | Social beer sharing | `OAuth` | ✅ | `Unknown` |
| [What's on the menu?](http://nypl.github.io/menus-api/) | NYPL human-transcribed historical menu collection | `apiKey` | ❌ | `Unknown` |
| [WhiskyHunter](https://whiskyhunter.net/api/) | Past online whisky auctions statistical data | `No` | ✅ | `Unknown` |
| [Zestful](https://zestfuldata.com/) | Parse recipe ingredients | `apiKey` | ✅ | ✅ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [Age of Empires II](https://age-of-empires-2-api.herokuapp.com) | Get information about Age of Empires II resources | `No` | ✅ | ❌ |
| [AmiiboAPI](https://amiiboapi.com/) | Nintendo Amiibo Information | `No` | ✅ | ✅ |
| [Animal Crossing: New Horizons](http://acnhapi.com/) | API for critters, fossils, art, music, furniture and villagers | `No` | ✅ | `Unknown` |
| [Autochess VNG](https://github.com/didadadida93/autochess-vng-api) | Rest Api for Autochess VNG | `No` | ✅ | ✅ |
| [Barter.VG](https://github.com/bartervg/barter.vg/wiki) | Provides information about Game, DLC, Bundles, Giveaways, Trading | `No` | ✅ | ✅ |
| [Battle.net](https://develop.battle.net/documentation/guides/getting-started) | Diablo III, Hearthstone, StarCraft II and World of Warcraft game data APIs | `OAuth` | ✅ | ✅ |
| [Board Game Geek](https://boardgamegeek.com/wiki/page/BGG_XML_API2) | Board games, RPG and videogames | `No` | ✅ | ❌ |
| [Brawl Stars](https://developer.brawlstars.com) | Brawl Stars Game Information | `apiKey` | ✅ | `Unknown` |
| [Bugsnax](https://www.bugsnaxapi.com/) | Get information about Bugsnax | `No` | ✅ | ✅ |
| [CheapShark](https://www.cheapshark.com/api) | Steam/PC Game Prices and Deals | `No` | ✅ | ✅ |
...
| [Crafatar](https://crafatar.com) | API for Minecraft skins and faces | `No` | ✅ | ✅ |
| [Cross Universe](https://crossuniverse.psychpsyo.com/apiDocs.html) | Cross Universe Card Data | `No` | ✅ | ✅ |
...
| [Disney](https://disneyapi.dev) | Information of Disney characters | `No` | ✅ | ✅ |
| [Dota 2](https://docs.opendota.com/) | Provides information about Player stats , Match stats, Rankings for Dota 2 | `apiKey` | ✅ | `Unknown` |
| [Dungeons and Dragons](https://www.dnd5eapi.co/docs/) | Reference for 5th edition spells, classes, monsters, and more | `No` | ❌ | ❌ |
| [Dungeons and Dragons (Alternate)](https://open5e.com/) | Includes all monsters and spells from the SRD (System Reference Document) as well as a search API | `No` | ✅ | ✅ |
| [Eve Online](https://esi.evetech.net/ui) | Third-Party Developer Documentation | `OAuth` | ✅ | `Unknown` |
| [FFXIV Collect](https://ffxivcollect.com/) | Final Fantasy XIV data on collectables | `No` | ✅ | ✅ |
| [FIFA Ultimate Team](https://www.easports.com/fifa/ultimate-team/api/fut/item) | FIFA Ultimate Team items API | `No` | ✅ | `Unknown` |
| [Final Fantasy XIV](https://xivapi.com/) | Final Fantasy XIV Game data API | `No` | ✅ | ✅ |
| [Fortnite](https://fortnitetracker.com/site-api) | Fortnite Stats | `apiKey` | ✅ | `Unknown` |
| [Forza](https://docs.forza-api.tk) | Show random image of car from Forza | `No` | ✅ | `Unknown` |
| [FreeToGame](https://www.freetogame.com/api-doc) | Free-To-Play Games Database | `No` | ✅ | ✅ |
| [Fun Facts](https://asli-fun-fact-api.herokuapp.com/) | Random Fun Facts | `No` | ✅ | ✅ |
| [FunTranslations](https://api.funtranslations.com/) | Translate Text into funny languages | `No` | ✅ | ✅ |
| [GamerPower](https://www.gamerpower.com/api-read) | Game Giveaways Tracker | `No` | ✅ | ✅ |
| [GDBrowser](https://gdbrowser.com/api) | Easy way to use the Geometry Dash Servers | `No` | ✅ | `Unknown` |
| [Geek-Jokes](https://github.com/sameerkumar18/geek-joke-api) | Fetch a random geeky/programming related joke for use in all sorts of applications | `No` | ✅ | ✅ |
| [Genshin Impact](https://genshin.dev) | Genshin Impact game data | `No` | ✅ | ✅ |
| [Giant Bomb](https://www.giantbomb.com/api/documentation) | Video Games | `apiKey` | ✅ | `Unknown` |
| [GraphQL Pokemon](https://github.com/favware/graphql-pokemon) | GraphQL powered Pokemon API. Supports generations 1 through 8 | `No` | ✅ | ✅ |
...
| [Hearthstone](http://hearthstoneapi.com/) | Hearthstone Cards Information | `X-Mashape-Key` | ✅ | `Unknown` |
...
| [Hytale](https://hytale-api.com/) | Hytale blog posts and jobs | `No` | ✅ | `Unknown` |
...
| [Jokes One](https://jokes.one/api/joke/) | Joke of the day and large category of jokes accessible via REST API | `apiKey` | ✅ | ✅ |
...
| [Mario Kart Tour](https://mario-kart-tour-api.herokuapp.com/) | API for Drivers, Karts, Gliders and Courses | `OAuth` | ✅ | `Unknown` |
| [Marvel](https://developer.marvel.com) | Marvel Comics | `apiKey` | ✅ | `Unknown` |
| [Minecraft Server Status](https://api.mcsrvstat.us) | API to get Information about a Minecraft Server | `No` | ✅ | ❌ |
| [MMO Games](https://www.mmobomb.com/api) | MMO Games Database, News and Giveaways | `No` | ✅ | ❌ |
...
| [Monster Hunter World](https://docs.mhw-db.com/) | Monster Hunter World data | `No` | ✅ | ✅ |
...
| [PokéAPI (GraphQL)](https://github.com/mazipan/graphql-pokeapi) | The Unofficial GraphQL for PokeAPI | `No` | ✅ | ✅ |
| [Pokémon TCG](https://pokemontcg.io) | Pokémon TCG Information | `No` | ✅ | `Unknown` |
| [Psychonauts](https://psychonauts-api.netlify.app/) | Psychonauts World Characters Information and PSI Powers | `No` | ✅ | ✅ |
| [PUBG](https://developer.pubg.com/) | Access in-game PUBG data | `apiKey` | ✅ | ✅ |
| [Puyo Nexus](https://github.com/deltadex7/puyodb-api-deno) | Puyo Puyo information from Puyo Nexus Wiki | `No` | ✅ | ✅ |
| [quizapi.io](https://quizapi.io/) | Access to various kind of quiz questions | `apiKey` | ✅ | ✅ |
...
| [Rick and Morty](https://rickandmortyapi.com) | All the Rick and Morty information, including images | `No` | ✅ | ✅ |
| [Riot Games](https://developer.riotgames.com/) | League of Legends Game Information | `apiKey` | ✅ | `Unknown` |
| [RPS 101](https://rps101.pythonanywhere.com/api) | Rock, Paper, Scissors with 101 objects | `No` | ✅ | ✅ |
| [RuneScape](https://runescape.wiki/w/Application_programming_interface) | RuneScape and OSRS RPGs information | `No` | ✅ | ❌ |
| [Sakura CardCaptor](https://github.com/JessVel/sakura-card-captor-api) | Sakura CardCaptor Cards Information | `No` | ✅ | `Unknown` |
| [Scryfall](https://scryfall.com/docs/api) | Magic: The Gathering database | `No` | ✅ | ✅ |
| [SpaceTradersAPI](https://spacetraders.io?rel=pub-apis) | A playable inter-galactic space trading MMOAPI | `OAuth` | ✅ | ✅ |
| [Steam](https://steamapi.xpaw.me/) | Steam Web API documentation | `apiKey` | ✅ | ❌ |
| [Steam](https://github.com/Revadike/InternalSteamWebAPI/wiki) | Internal Steam Web API documentation | `No` | ✅ | ❌ |
| [SuperHeroes](https://superheroapi.com) | All SuperHeroes and Villains data from all universes under a single API | `apiKey` | ✅ | `Unknown` |
| [TCGdex](https://www.tcgdex.net/docs) | Multi languages Pokémon TCG Information | `No` | ✅ | ✅ |
| [Tebex](https://docs.tebex.io/plugin/) | Tebex API for information about game purchases | `X-Mashape-Key` | ✅ | ❌ |
| [TETR.IO](https://tetr.io/about/api/) | TETR.IO Tetra Channel API | `No` | ✅ | `Unknown` |
| [Tronald Dump](https://www.tronalddump.io/) | The dumbest things Donald Trump has ever said | `No` | ✅ | `Unknown` |
| [Universalis](https://universalis.app/docs/index.html) | Final Fantasy XIV market board data | `No` | ✅ | ✅ |
...
| [Warface (non-official)](https://api.wfstats.cf) | Official API proxy with better data structure and more features | `No` | ✅ | ❌ |
| [Wargaming.net](https://developers.wargaming.net/) | Wargaming.net info and stats | `apiKey` | ✅ | ❌ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [IPstack](https://ipstack.com/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers) | Locate and identify website visitors by IP address | `apiKey` | ✅ | `Unknown` |
| [ipapi.com](https://ipapi.com/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers) | Real-time Geolocation & Reverse IP Lookup REST API | `apiKey` | ✅ | `Unknown` |
...
| [administrative-divisons-db](https://github.com/kamikazechaser/administrative-divisions-db) | Get all administrative divisions of a country | `No` | ✅ | ✅ |
| [adresse.data.gouv.fr](https://adresse.data.gouv.fr) | Address database of France, geocoding and reverse | `No` | ✅ | `Unknown` |
| [Airtel IP](https://sys.airtel.lv/ip2country/1.1.1.1/?full=true) | IP Geolocation API. Collecting data from multiple sources | `No` | ✅ | `Unknown` |
| [Apiip](https://apiip.net/) | Get location information by IP address | `apiKey` | ✅ | ✅ |
| [Battuta](http://battuta.medunes.net) | A (country/region/city) in-cascade location API | `apiKey` | ❌ | `Unknown` |
| [BigDataCloud](https://www.bigdatacloud.com/ip-geolocation-apis) | Provides fast and accurate IP geolocation APIs along with security checks and confidence area | `apiKey` | ✅ | `Unknown` |
| [Bing Maps](https://www.microsoft.com/maps/) | Create/customize digital maps based on Bing Maps data | `apiKey` | ✅ | `Unknown` |
| [bng2latlong](https://www.getthedata.com/bng2latlong) | Convert British OSGB36 easting and northing (British National Grid) to WGS84 latitude and longitude | `No` | ✅ | ✅ |
...
| [CitySDK](http://www.citysdk.eu/citysdk-toolkit/) | Open APIs for select European cities | `No` | ✅ | `Unknown` |
| [Country](http://country.is/) | Get your visitor's country from their IP | `No` | ✅ | ✅ |
| [CountryStateCity](https://countrystatecity.in/) | World countries, states, regions, provinces, cities & towns in JSON, SQL, XML, YAML, & CSV format | `apiKey` | ✅ | ✅ |
...
| [Geoapify](https://www.geoapify.com/api/geocoding-api/) | Forward and reverse geocoding, address autocomplete | `apiKey` | ✅ | ✅ |
...
| [Geocodify.com](https://geocodify.com/) | Worldwide geocoding, geoparsing and autocomplete for addresses | `apiKey` | ✅ | ✅ |
...
| [GeoDB Cities](http://geodb-cities-api.wirefreethought.com/) | Get global city, region, and country data | `apiKey` | ✅ | `Unknown` |
| [GeographQL](https://geographql.netlify.app) | A Country, State, and City GraphQL API | `No` | ✅ | ✅ |
| [GeoJS](https://www.geojs.io/) | IP geolocation with ChatOps integration | `No` | ✅ | ✅ |
| [Geokeo](https://geokeo.com) | Geokeo geocoding service- with 2500 free api requests daily | `No` | ✅ | ✅ |
| [GeoNames](http://www.geonames.org/export/web-services.html) | Place names and other geographical data | `No` | ❌ | `Unknown` |
| [geoPlugin](https://www.geoplugin.com) | IP geolocation and currency conversion | `No` | ✅ | ✅ |
...
| [Hirak IP to Country](https://iplocation.hirak.site/) | Ip to location with country code, currency code & currency name, fast response, unlimited requests | `apiKey` | ✅ | `Unknown` |
...
| [IP Vigilante](https://www.ipvigilante.com/) | Free IP Geolocation API | `No` | ✅ | `Unknown` |
| [ip-api](https://ip-api.com/docs) | Find location with IP address or domain | `No` | ❌ | `Unknown` |
| [IP Geolocation](https://www.abstractapi.com/ip-geolocation-api) | Geolocate website visitors from their IPs | `apiKey` | ✅ | ✅ |
...
| [ipapi.co](https://ipapi.co/api/#introduction) | Find IP address location information | `No` | ✅ | ✅ |
| [IPGEO](https://api.techniknews.net/ipgeo/) | Unlimited free IP Address API with useful information | `No` | ✅ | `Unknown` |
| [ipgeolocation](https://ipgeolocation.io/) | IP Geolocation AP with free plan 30k requests per month | `apiKey` | ✅ | ✅ |
...
| [ipstack](https://ipstack.com/) | Locate and identify website visitors by IP address | `apiKey` | ✅ | `Unknown` |
...
| [LocationIQ](https://locationiq.org/docs/) | Provides forward/reverse geocoding and batch geocoding | `apiKey` | ✅ | ✅ |
| [Longdo Map](https://map.longdo.com/docs/) | Interactive map with detailed places and information portal in Thailand | `apiKey` | ✅ | ✅ |
| [Mapbox](https://docs.mapbox.com/) | Create/customize beautiful digital maps | `apiKey` | ✅ | `Unknown` |
| [MapQuest](https://developer.mapquest.com/) | To access tools and resources to map the world | `apiKey` | ✅ | ❌ |
| [Mexico](https://github.com/IcaliaLabs/sepomex) | Mexico RESTful zip codes API | `No` | ✅ | `Unknown` |
| [Nominatim](https://nominatim.org/release-docs/latest/api/Overview/) | Provides worldwide forward / reverse geocoding | `No` | ✅ | ✅ |
...
| [Open Topo Data](https://www.opentopodata.org) | Elevation and ocean depth for a latitude and longitude | `No` | ✅ | ❌ |
| [OpenCage](https://opencagedata.com) | Forward and reverse geocoding using open data | `apiKey` | ✅ | ✅ |
...
| [OpenStreetMap](http://wiki.openstreetmap.org/wiki/API) | Navigation, geolocation and geographical data | `OAuth` | ❌ | `Unknown` |
| [Pinball Map](https://pinballmap.com/api/v1/docs) | A crowdsourced map of public pinball machines | `No` | ✅ | ✅ |
| [positionstack](https://positionstack.com/) | Forward & Reverse Batch Geocoding REST API | `apiKey` | ✅ | `Unknown` |
| [Postali](https://postali.app/api) | Mexico Zip Codes API | `No` | ✅ | ✅ |
...
| [Postcodes.io](https://postcodes.io) | Postcode lookup & Geolocation for the UK | `No` | ✅ | ✅ |
| [Queimadas INPE](https://queimadas.dgi.inpe.br/queimadas/dados-abertos/) | Access to heat focus data (probable wildfire) | `No` | ✅ | `Unknown` |
| [REST Countries](https://restcountries.com) | Get information about countries via a RESTful API | `No` | ✅ | ✅ |
| [RoadGoat Cities](https://www.roadgoat.com/business/cities-api) | Cities content & photos API | `apiKey` | ✅ | ❌ |
| [Rwanda Locations](https://rapidapi.com/victorkarangwa4/api/rwanda) | Rwanda Provences, Districts, Cities, Capital City, Sector, cells, villages and streets | `No` | ✅ | `Unknown` |
| [SLF](https://github.com/slftool/slftool.github.io/blob/master/API.md) | German city, country, river, database | `No` | ✅ | ✅ |
| [SpotSense](https://spotsense.io/) | Add location based interactions to your mobile app | `apiKey` | ✅ | `Unknown` |
| [Telize](https://rapidapi.com/fcambus/api/telize/) | Telize offers location information from any IP address | `apiKey` | ✅ | ✅ |
| [TomTom](https://developer.tomtom.com/) | Maps, Directions, Places and Traffic APIs | `apiKey` | ✅ | ✅ |
| [Uebermaps](https://uebermaps.com/api/v2) | Discover and share maps with friends | `apiKey` | ✅ | `Unknown` |
| [US ZipCode](https://www.smarty.com/docs/cloud/us-zipcode-api) | Validate and append data for any US ZipCode | `apiKey` | ✅ | ✅ |
...
| [Brazil](https://brasilapi.com.br/) | Community driven API for Brazil Public Data | `No` | ✅ | ✅ |
...
| [Brazilian Chamber of Deputies Open Data](https://dadosabertos.camara.leg.br/swagger/api.html) | Provides legislative information in Apis XML and JSON, as well as files in various formats | `No` | ✅ | ❌ |
...
| [City, Toronto Open Data](https://open.toronto.ca/) | Toronto (CA) City Open Data | `No` | ✅ | ✅ |
...
| [District of Columbia Open Data](http://opendata.dc.gov/pages/using-apis) | Contains D.C. government public datasets, including crime, GIS, financial data, and so on | `No` | ✅ | `Unknown` |
...
| [Gun Policy](https://www.gunpolicy.org/api) | International firearm injury prevention and policy | `apiKey` | ✅ | `Unknown` |
...
| [National Park Service, US](https://www.nps.gov/subjects/developer/) | Data from the US National Park Service | `apiKey` | ✅ | ✅ |
...
| [Open Government, Cyprus](https://data.gov.cy/?language=en) | Cyprus Government Open Data | `No` | ✅ | `Unknown` |
...
| [Open Government, Norway](https://data.norge.no/dataservices) | Norwegian Government Open Data | `No` | ✅ | ✅ |
| [Open Government, Peru](https://www.datosabiertos.gob.pe/) | Peru Government Open Data | `No` | ✅ | `Unknown` |
| [Open Government, Poland](https://dane.gov.pl/en) | Poland Government Open Data | `No` | ✅ | ✅ |
| [Open Government, Portugal](https://dados.gov.pt/en/docapi/) | Portugal Government Open Data | `No` | ✅ | ✅ |
...
| [Open Government, Slovenia](https://podatki.gov.si/) | Slovenia Government Open Data | `No` | ✅ | ❌ |
...
| [PRC Exam Schedule](https://api.whenisthenextboardexam.com/docs/) | Unofficial Philippine Professional Regulation Commission's examination schedule | `No` | ✅ | ✅ |
...
| [US Presidential Election Data by TogaTech](https://uselection.togatech.org/api/) | Basic candidate data and live electoral vote counts for top two parties in US presidential election | `No` | ✅ | ❌ |
| [USA.gov](https://www.usa.gov/developer) | Authoritative information on U.S. programs, events, services and more | `apiKey` | ✅ | `Unknown` |
...
| [Coronavirus](https://pipedream.com/@pravin/http-api-for-latest-wuhan-coronavirus-data-2019-ncov-p_G6CLVM/readme) | HTTP API for Latest Covid-19 Data | `No` | ✅ | `Unknown` |
...
| [Covid Tracking Project](https://covidtracking.com/data/api/version-2) | Covid-19 data for the US | `No` | ✅ | ❌ |
| [Covid-19](https://covid19api.com/) | Covid 19 spread, infection and recovery | `No` | ✅ | ✅ |
| [Covid-19](https://github.com/M-Media-Group/Covid-19-API) | Covid 19 cases, deaths and recovery per country | `No` | ✅ | ✅ |
...
| [Covid-19 Government Response](https://covidtracker.bsg.ox.ac.uk) | Government measures tracker to fight against the Covid-19 pandemic | `No` | ✅ | ✅ |
...
| [Covid-19 JHU CSSE](https://nuttaphat.com/covid19-api/) | Open-source API for exploring Covid19 cases based on JHU CSSE | `No` | ✅ | ✅ |
| [Covid-19 Live Data](https://github.com/mathdroid/covid-19-api) | Global and countrywise data of Covid 19 daily Summary, confirmed cases, recovered and deaths | `No` | ✅ | ✅ |
| [Covid-19 Philippines](https://github.com/Simperfy/Covid-19-API-Philippines-DOH) | Unofficial Covid-19 Web API for Philippines from data collected by DOH | `No` | ✅ | ✅ |
...
| [COVID-ID](https://data.covid19.go.id/public/api/prov.json) | Indonesian government Covid data per province | `No` | ✅ | ✅ |
...
| [Infermedica](https://developer.infermedica.com/docs/) | NLP based symptom checker and patient triage API for health diagnosis from text | `apiKey` | ✅ | ✅ |
| [LAPIS](https://cov-spectrum.ethz.ch/public) | SARS-CoV-2 genomic sequences from public sources | `No` | ✅ | ✅ |
...
| [Open Disease](https://disease.sh/) | API for Current cases and more stuff about COVID-19 and Influenza | `No` | ✅ | ✅ |
| [openFDA](https://open.fda.gov) | Public FDA data about drugs, devices and foods | `apiKey` | ✅ | `Unknown` |
| [Orion Health](https://developer.orionhealth.io/) | Medical platform which allows the development of applications for different healthcare scenarios | `OAuth` | ✅ | `Unknown` |
| [Quarantine](https://quarantine.country/coronavirus/api/) | Coronavirus API with free COVID-19 live updates | `No` | ✅ | ✅ |
...
| [Arbeitnow](https://documenter.getpostman.com/view/18545278/UVJbJdKh) | API for Job board aggregator in Europe / Remote | `No` | ✅ | ✅ |
...
| [DevITjobs UK](https://devitjobs.uk/job_feed.xml) | Jobs with GraphQL | `No` | ✅ | ✅ |
| [Findwork](https://findwork.dev/developers/) | Job board | `apiKey` | ✅ | `Unknown` |
| [GraphQL Jobs](https://graphql.jobs/docs/api/) | Jobs with GraphQL | `No` | ✅ | ✅ |
| [Jobs2Careers](http://api.jobs2careers.com/api/spec.pdf) | Job aggregator | `apiKey` | ✅ | `Unknown` |
| [Jooble](https://jooble.org/api/about) | Job search engine | `apiKey` | ✅ | `Unknown` |
| [Juju](http://www.juju.com/publisher/spec/) | Job search engine | `apiKey` | ❌ | `Unknown` |
...
| [ZipRecruiter](https://www.ziprecruiter.com/publishers) | Job search app and website | `apiKey` | ✅ | `Unknown` |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [AI For Thai](https://aiforthai.in.th/index.php) | Free Various Thai AI API | `apiKey` | ✅ | ✅ |
| [Clarifai](https://docs.clarifai.com/api-guide/api-overview) | Computer Vision | `OAuth` | ✅ | `Unknown` |
| [Cloudmersive](https://www.cloudmersive.com/image-recognition-and-processing-api) | Image captioning, face recognition, NSFW classification | `apiKey` | ✅ | ✅ |
| [Deepcode](https://www.deepcode.ai) | AI for code review | `No` | ✅ | `Unknown` |
| [Dialogflow](https://cloud.google.com/dialogflow/docs/) | Natural Language Processing | `apiKey` | ✅ | `Unknown` |
| [EXUDE-API](http://uttesh.com/exude-api/) | Used for the primary ways for filtering the stopping, stemming words from the text data | `No` | ✅ | ✅ |
| [Hirak FaceAPI](https://faceapi.hirak.site/) | Face detection, face recognition with age estimation/gender estimation, accurate, no quota limits | `apiKey` | ✅ | `Unknown` |
...
| [IPS Online](https://docs.identity.ps/docs) | Face and License Plate Anonymization | `apiKey` | ✅ | `Unknown` |
| [Irisnet](https://irisnet.de/api/) | Realtime content moderation API that blocks or blurs unwanted images in real-time | `apiKey` | ✅ | ✅ |
| [Keen IO](https://keen.io/) | Data Analytics | `apiKey` | ✅ | `Unknown` |
| [Machinetutors](https://www.machinetutors.com/portfolio/MT_api.html) | AI Solutions: Video/Image Classification & Tagging, NSFW, Icon/Image/Audio Search, NLP | `apiKey` | ✅ | ✅ |
| [MessengerX.io](https://messengerx.rtfd.io) | A FREE API for developers to build and monetize personalized ML based chat apps | `apiKey` | ✅ | ✅ |
...
| [OpenVisionAPI](https://openvisionapi.com) | Open source computer vision API based on open source models | `No` | ✅ | ✅ |
...
| [Roboflow Universe](https://universe.roboflow.com) | Pre-trained computer vision models | `apiKey` | ✅ | ✅ |
| [SkyBiometry](https://skybiometry.com/documentation/) | Face Detection, Face Recognition and Face Grouping | `apiKey` | ✅ | `Unknown` |
| [Time Door](https://timedoor.io) | A time series analysis API | `apiKey` | ✅ | ✅ |
...
| [AI Mastering](https://aimastering.com/api_docs/) | Automated Music Mastering | `apiKey` | ✅ | ✅ |
...
| [iTunes Search](https://affiliate.itunes.apple.com/resources/documentation/itunes-store-web-service-search-api/) | Software products | `No` | ✅ | `Unknown` |
...
| [KSoft.Si Lyrics](https://docs.ksoft.si/api/lyrics-api) | API to get lyrics for songs | `apiKey` | ✅ | `Unknown` |
| [LastFm](https://www.last.fm/api) | Music | `apiKey` | ✅ | `Unknown` |
| [Lyrics.ovh](https://lyricsovh.docs.apiary.io) | Simple API to retrieve the lyrics of a song | `No` | ✅ | `Unknown` |
...
| [Musixmatch](https://developer.musixmatch.com/) | Music | `apiKey` | ✅ | `Unknown` |
| [Napster](https://developer.napster.com/api/v2.2) | Music | `apiKey` | ✅ | ✅ |
| [Openwhyd](https://openwhyd.github.io/openwhyd/API) | Download curated playlists of streaming tracks (YouTube, SoundCloud, etc...) | `No` | ✅ | ❌ |
| [Phishin](https://phish.in/api-docs) | A web-based archive of legal live audio recordings of the improvisational rock band Phish | `apiKey` | ✅ | ❌ |
| [Radio Browser](https://api.radio-browser.info/) | List of internet radio stations | `No` | ✅ | ✅ |
| [Songkick](https://www.songkick.com/developer/) | Music Events | `apiKey` | ✅ | `Unknown` |
| [Songlink / Odesli](https://www.notion.so/API-d0ebe08a5e304a55928405eb682f6741) | Get all the services on which a song is available | `apiKey` | ✅ | ✅ |
| [Songsterr](https://www.songsterr.com/a/wa/api/) | Provides guitar, bass and drums tabs and chords | `No` | ✅ | `Unknown` |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [Mediastack](https://mediastack.com?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers) | Free, Simple REST API for Live News & Blog Articles | `apiKey` | ✅ | `Unknown` |
...
| [Currents](https://currentsapi.services/) | Latest news published in various news sources, blogs and forums | `apiKey` | ✅ | ✅ |
| [Feedbin](https://github.com/feedbin/feedbin-api) | RSS reader | `OAuth` | ✅ | `Unknown` |
| [GNews](https://gnews.io/) | Search for news from various sources | `apiKey` | ✅ | ✅ |
| [Graphs for Coronavirus](https://corona.dnsforfamily.com/api.txt) | Each Country separately and Worldwide Graphs for Coronavirus. Daily updates | `No` | ✅ | ✅ |
| [Inshorts News](https://github.com/cyberboysumanjay/Inshorts-News-API) | Provides news from inshorts | `No` | ✅ | `Unknown` |
| [MarketAux](https://www.marketaux.com/) | Live stock market news with tagged tickers + sentiment and stats JSON API | `apiKey` | ✅ | ✅ |
...
| [NPR One](http://dev.npr.org/api/) | Personalized news listening experience from NPR | `OAuth` | ✅ | `Unknown` |
| [Spaceflight News](https://spaceflightnewsapi.net) | Spaceflight related news 🚀 | `No` | ✅ | ✅ |
| [The Guardian](http://open-platform.theguardian.com/) | Access all the content the Guardian creates, categorised by tags and section | `apiKey` | ✅ | `Unknown` |
| [The Old Reader](https://github.com/theoldreader/api) | RSS reader | `apiKey` | ✅ | `Unknown` |
| [TheNews](https://www.thenewsapi.com/) | Aggregated headlines, top story and live news JSON API | `apiKey` | ✅ | ✅ |
...
| [API Setu](https://www.apisetu.gov.in/) | An Indian Government platform that provides a lot of APIS for KYC, business, education & employment | `No` | ✅ | ✅ |
| [Archive.org](https://archive.readme.io/docs) | The Internet Archive | `No` | ✅ | ❌ |
| [Black History Facts](https://www.blackhistoryapi.io/docs) | Contribute or search one of the largest black history fact databases on the web | `apiKey` | ✅ | ✅ |
...
| [Enigma Public](https://developers.enigma.com/docs) | Broadest collection of public data | `apiKey` | ✅ | ✅ |
...
| [LinkPreview](https://www.linkpreview.net) | Get JSON formatted summary with title, description and preview image for any requested URL | `apiKey` | ✅ | ✅ |
...
| [Microlink.io](https://microlink.io) | Extract structured data from any website | `No` | ✅ | ✅ |
| [Nasdaq Data Link](https://docs.data.nasdaq.com/) | Stock market data | `apiKey` | ✅ | `Unknown` |
| [Nobel Prize](https://www.nobelprize.org/about/developer-zone-2/) | Open data about nobel prizes and events | `No` | ✅ | ✅ |
| [Open Data Minneapolis](https://opendata.minneapolismn.gov/) | Spatial (GIS) and non-spatial city data for Minneapolis | `No` | ✅ | ❌ |
| [openAFRICA](https://africaopendata.org/) | Large datasets repository of African open data | `No` | ✅ | `Unknown` |
| [OpenCorporates](http://api.opencorporates.com/documentation/API-Reference) | Data on corporate entities and directors in many countries | `apiKey` | ✅ | `Unknown` |
| [OpenSanctions](https://www.opensanctions.org/docs/api/) | Data on international sanctions, crime and politically exposed persons | `No` | ✅ | ✅ |
| [PeakMetrics](https://rapidapi.com/peakmetrics-peakmetrics-default/api/peakmetrics-news) | News articles and public datasets | `apiKey` | ✅ | `Unknown` |
...
| [Scoop.it](http://www.scoop.it/dev) | Content Curation Service | `apiKey` | ❌ | `Unknown` |
| [Socrata](https://dev.socrata.com/) | Access to Open Data from Governments, Non-profits and NGOs around the world | `OAuth` | ✅ | ✅ |
| [Teleport](https://developers.teleport.org/) | Quality of Life Data | `No` | ✅ | `Unknown` |
| [Umeå Open Data](https://opendata.umea.se/api/) | Open data of the city Umeå in northen Sweden | `No` | ✅ | ✅ |
...
| [Urban Observatory](https://urbanobservatory.ac.uk) | The largest set of publicly available real time urban data in the UK | `No` | ❌ | ❌ |
| [Wikidata](https://www.wikidata.org/w/api.php?action=help) | Collaboratively edited knowledge base operated by the Wikimedia Foundation | `OAuth` | ✅ | `Unknown` |
| [Wikipedia](https://www.mediawiki.org/wiki/API:Main_page) | Mediawiki Encyclopedia | `No` | ✅ | `Unknown` |
| [Yelp](https://www.yelp.com/developers/documentation/v3) | Find Local Business | `OAuth` | ✅ | `Unknown` |
...
| [Creative Commons Catalog](https://api.creativecommons.engineering/) | Search among openly licensed and public domain works | `OAuth` | ✅ | ✅ |
...
| [Evil Insult Generator](https://evilinsult.com/api) | Evil Insults | `No` | ✅ | ✅ |
| [GitHub Contribution Chart Generator](https://github-contributions.vercel.app) | Create an image of your GitHub contributions | `No` | ✅ | ✅ |
| [GitHub ReadMe Stats](https://github.com/anuraghazra/github-readme-stats) | Add dynamically generated statistics to your GitHub profile ReadMe | `No` | ✅ | ✅ |
| [Metabase](https://www.metabase.com/) | An open source Business Intelligence server to share data and analytics inside your company | `No` | ✅ | ✅ |
...
| [TIPO](https://tiponet.tipo.gov.tw/Gazette/OpenData/OD/OD05.aspx?QryDS=API00) | Taiwan patent search system api | `apiKey` | ✅ | `Unknown` |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [Advice Slip](http://api.adviceslip.com/) | Generate random advice slips | `No` | ✅ | `Unknown` |
| [Biriyani As A Service](https://biriyani.anoram.com/) | Biriyani images placeholder | `No` | ✅ | ❌ |
| [Dev.to](https://developers.forem.com/api) | Access Forem articles, users and other resources via API | `apiKey` | ✅ | `Unknown` |
| [Dictum](https://github.com/fisenkodv/dictum) | API to get access to the collection of the most inspiring expressions of mankind | `No` | ✅ | `Unknown` |
...
| [Inspiration](https://inspiration.goprogram.ai/docs/) | Motivational and Inspirational quotes | `No` | ✅ | ✅ |
| [kanye.rest](https://kanye.rest) | REST API for random Kanye West quotes | `No` | ✅ | ✅ |
| [kimiquotes](https://kimiquotes.herokuapp.com/doc) | Team radio and interview quotes by Finnish F1 legend Kimi Räikkönen | `No` | ✅ | ✅ |
...
| [quoteclear](https://quoteclear.web.app/) | Ever-growing list of James Clear quotes from the 3-2-1 Newsletter | `No` | ✅ | ✅ |
...
| [Vadivelu HTTP Codes](https://vadivelu.anoram.com/) | On demand HTTP Codes with images | `No` | ✅ | ❌ |
| [Zen Quotes](https://zenquotes.io/) | Large collection of Zen quotes for inspiration | `No` | ✅ | ✅ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [Numverify](https://numverify.com?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers) | Phone number validation | `apiKey` | ✅ | `Unknown` |
| [Cloudmersive Validate](https://cloudmersive.com/phone-number-validation-API) | Validate international phone numbers | `apiKey` | ✅ | ✅ |
| [Phone Specification](https://github.com/azharimm/phone-specs-api) | Rest Api for Phone specifications | `No` | ✅ | ✅ |
| [Phone Validation](https://www.abstractapi.com/phone-validation-api) | Validate phone numbers globally | `apiKey` | ✅ | ✅ |
| [Veriphone](https://veriphone.io) | Phone number validation & carrier lookup | `apiKey` | ✅ | ✅ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [Screenshotlayer](https://screenshotlayer.com?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers) | URL to screenshot | `No` | ✅ | `Unknown` |
| [APITemplate.io](https://apitemplate.io) | Dynamically generate images and PDFs from templates with a simple API | `apiKey` | ✅ | ✅ |
| [Bruzu](https://docs.bruzu.com) | Image generation with query string | `apiKey` | ✅ | ✅ |
...
| [Duply](https://duply.co/docs#getting-started-api) | Generate, Edit, Scale and Manage Images and Videos Smarter & Faster | `apiKey` | ✅ | ✅ |
| [DynaPictures](https://dynapictures.com/docs/) | Generate Hundreds of Personalized Images in Minutes | `apiKey` | ✅ | ✅ |
| [Flickr](https://www.flickr.com/services/api/) | Flickr Services | `OAuth` | ✅ | `Unknown` |
| [Getty Images](http://developers.gettyimages.com/en/) | Build applications using the world's most powerful imagery | `OAuth` | ✅ | `Unknown` |
| [Gfycat](https://developers.gfycat.com/api/) | Jiffier GIFs | `OAuth` | ✅ | `Unknown` |
...
| [Image Upload](https://apilayer.com/marketplace/image_upload-api) | Image Optimization | `apiKey` | ✅ | `Unknown` |
| [Imgur](https://apidocs.imgur.com/) | Images | `OAuth` | ✅ | `Unknown` |
| [Imsea](https://imsea.herokuapp.com/) | Free image search | `No` | ✅ | `Unknown` |
| [Lorem Picsum](https://picsum.photos/) | Images from Unsplash | `No` | ✅ | `Unknown` |
| [ObjectCut](https://objectcut.com/) | Image Background removal | `apiKey` | ✅ | ✅ |
| [Pexels](https://www.pexels.com/api/) | Free Stock Photos and Videos | `apiKey` | ✅ | ✅ |
...
| [KONTESTS](https://kontests.net/api) | For upcoming and ongoing competitive coding contests | `No` | ✅ | `Unknown` |
| [Mintlify](https://docs.mintlify.com) | For programmatically generating documentation for code | `apiKey` | ✅ | ✅ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [arcsecond.io](https://api.arcsecond.io/) | Multiple astronomy data sources | `No` | ✅ | `Unknown` |
| [arXiv](https://arxiv.org/help/api/user-manual) | Curated research-sharing platform: physics, mathematics, quantitative finance, and economics | `No` | ✅ | `Unknown` |
| [CORE](https://core.ac.uk/services#api) | Access the world's Open Access research papers | `apiKey` | ✅ | `Unknown` |
| [GBIF](https://www.gbif.org/developer/summary) | Global Biodiversity Information Facility | `No` | ✅ | ✅ |
...
| [ISRO](https://isro.vercel.app) | ISRO Space Crafts Information | `No` | ✅ | ❌ |
...
| [Materials Platform for Data Science](https://mpds.io) | Curated experimental data for materials science | `apiKey` | ✅ | ❌ |
...
| [NASA ADS](https://ui.adsabs.harvard.edu/help/api/api-docs.html) | NASA Astrophysics Data System | `OAuth` | ✅ | ✅ |
...
| [Numbers](https://math.tools/api/numbers/) | Number of the day, random number, number facts and anything else you want to do with numbers | `apiKey` | ✅ | ❌ |
| [Numbers](http://numbersapi.com) | Facts about numbers | `No` | ❌ | ❌ |
| [Ocean Facts](https://oceanfacts.herokuapp.com/) | Facts pertaining to the physical science of Oceanography | `No` | ✅ | `Unknown` |
| [Open Notify](http://open-notify.org/Open-Notify-API/) | ISS astronauts, current location, etc | `No` | ❌ | ❌ |
| [Open Science Framework](https://developer.osf.io) | Repository and archive for study designs, research materials, data, manuscripts, etc | `No` | ✅ | `Unknown` |
| [Purple Air](https://www2.purpleair.com/) | Real Time Air Quality Monitoring | `No` | ✅ | `Unknown` |
| [Remote Calc](https://github.com/elizabethadegbaju/remotecalc) | Decodes base64 encoding and parses it to return a solution to the calculation in JSON | `No` | ✅ | ✅ |
| [SHARE](https://share.osf.io/api/v2/) | A free, open, dataset about research and scholarly activities | `No` | ✅ | ❌ |
| [SpaceX](https://github.com/r-spacex/SpaceX-API) | Company, vehicle, launchpad and launch data | `No` | ✅ | ❌ |
| [SpaceX](https://api.spacex.land/graphql/) | GraphQL, Company, Ships, launchpad and launch data | `No` | ✅ | `Unknown` |
| [Sunrise and Sunset](https://sunrise-sunset.org/api) | Sunset and sunrise times for a given latitude and longitude | `No` | ✅ | ❌ |
| [Times Adder](https://github.com/FranP-code/API-Times-Adder) | With this API you can add each of the times introduced in the array sended | `No` | ✅ | ❌ |
| [TLE](https://tle.ivanstanojevic.me/#/docs) | Satellite information | `No` | ✅ | ❌ |
| [USGS Earthquake Hazards Program](https://earthquake.usgs.gov/fdsnws/event/1/) | Earthquakes data real-time | `No` | ✅ | ❌ |
| [USGS Water Services](https://waterservices.usgs.gov/) | Water quality and level info for rivers and lakes | `No` | ✅ | ❌ |
| [World Bank](https://datahelpdesk.worldbank.org/knowledgebase/topics/125589) | World Data | `No` | ✅ | ❌ |
| [xMath](https://x-math.herokuapp.com/) | Random mathematical expressions | `No` | ✅ | ✅ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [Application Environment Verification](https://github.com/fingerprintjs/aev) | Android library and API to verify the safety of user devices, detect rooted devices and other risks | `apiKey` | ✅ | ✅ |
| [BinaryEdge](https://docs.binaryedge.io/api-v2.html) | Provide access to BinaryEdge 40fy scanning platform | `apiKey` | ✅ | ✅ |
| [BitWarden](https://bitwarden.com/help/api/) | Best open-source password manager | `OAuth` | ✅ | `Unknown` |
| [Botd](https://github.com/fingerprintjs/botd) | Botd is a browser library for JavaScript bot detection | `apiKey` | ✅ | ✅ |
...
| [Censys](https://search.censys.io/api) | Search engine for Internet connected host and devices | `apiKey` | ✅ | ❌ |
| [Classify](https://classify-web.herokuapp.com/#/api) | Encrypting & decrypting text messages | `No` | ✅ | ✅ |
| [Complete Criminal Checks](https://completecriminalchecks.com/Developers) | Provides data of offenders from all U.S. States and Pureto Rico | `apiKey` | ✅ | ✅ |
| [CRXcavator](https://crxcavator.io/apidocs) | Chrome extension risk scoring | `apiKey` | ✅ | `Unknown` |
| [Dehash.lt](https://github.com/Dehash-lt/api) | Hash decryption MD5, SHA1, SHA3, SHA256, SHA384, SHA512 | `No` | ✅ | `Unknown` |
| [EmailRep](https://docs.emailrep.io/) | Email address threat and risk prediction | `No` | ✅ | `Unknown` |
| [Escape](https://github.com/polarspetroll/EscapeAPI) | An API for escaping different kind of queries | `No` | ✅ | ❌ |
| [FilterLists](https://filterlists.com) | Lists of filters for adblockers and firewalls | `No` | ✅ | `Unknown` |
| [FingerprintJS Pro](https://dev.fingerprintjs.com/docs) | Fraud detection API offering highly accurate browser fingerprinting | `apiKey` | ✅ | ✅ |
...
| [GitGuardian](https://api.gitguardian.com/doc) | Scan files for secrets (API Keys, database credentials) | `apiKey` | ✅ | ❌ |
...
| [Hashable](https://hashable.space/pages/api/) | A REST API to access high level cryptographic functions and methods | `No` | ✅ | ✅ |
...
| [LoginRadius](https://www.loginradius.com/docs/) | Managed User Authentication Service | `apiKey` | ✅ | ✅ |
...
| [Passwordinator](https://github.com/fawazsullia/password-generator/) | Generate random passwords of varying complexities | `No` | ✅ | ✅ |
...
| [SecurityTrails](https://securitytrails.com/corp/apidocs) | Domain and IP related information such as current and historical WHOIS and DNS records | `apiKey` | ✅ | `Unknown` |
...
| [Threat Jammer](https://threatjammer.com/docs/index) | Risk scoring service from curated threat intelligence data | `apiKey` | ✅ | `Unknown` |
| [UK Police](https://data.police.uk/docs/) | UK Police data | `No` | ✅ | `Unknown` |
| [Virushee](https://api.virushee.com/) | Virushee file/data scanning | `No` | ✅ | ✅ |
| [VulDB](https://vuldb.com/?doc.api) | VulDB API allows to initiate queries for one or more items along with transactional bots | `apiKey` | ✅ | `Unknown` |
...
| [Digi-Key](https://www.digi-key.com/en/resources/api-solutions) | Retrieve price and inventory of electronic components as well as place orders | `OAuth` | ✅ | `Unknown` |
| [Dummy Products](https://dummyproducts-api.herokuapp.com/) | An api to fetch dummy e-commerce products JSON data with placeholder images | `apiKey` | ✅ | ✅ |
...
| [Flipkart Marketplace](https://seller.flipkart.com/api-docs/FMSAPI.html) | Product listing management, Order Fulfilment in the Flipkart Marketplace | `OAuth` | ✅ | ✅ |
...
| [Octopart](https://octopart.com/api/v4/reference) | Electronic part data for manufacturing, design, and sourcing | `apiKey` | ✅ | `Unknown` |
...
| [Shopee](https://open.shopee.com/documents?version=1) | Shopee's official API for integration of various services from Shopee | `apiKey` | ✅ | `Unknown` |
...
| [WooCommerce](https://woocommerce.github.io/woocommerce-rest-api-docs/) | WooCommerce REST APIS to create, read, update, and delete data on wordpress website in JSON format | `apiKey` | ✅ | ✅ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [4chan](https://github.com/4chan/4chan-API) | Simple image-based bulletin board dedicated to a variety of topics | `No` | ✅ | ✅ |
| [Ayrshare](https://www.ayrshare.com) | Social media APIs to post, get analytics, and manage multiple users social media accounts | `apiKey` | ✅ | ✅ |
| [aztro](https://aztro.sameerkumar.website/) | Daily horoscope info for yesterday, today, and tomorrow | `No` | ✅ | `Unknown` |
...
| [Cisco Spark](https://developer.ciscospark.com) | Team Collaboration Software | `OAuth` | ✅ | `Unknown` |
| [Dangerous Discord Database](https://discord.riverside.rocks/docs/index.php) | Database of malicious Discord accounts | `apiKey` | ✅ | `Unknown` |
...
| [Doge-Meme](https://api.doge-meme.lol/docs) | Top meme posts from r/dogecoin which include 'Meme' flair | `No` | ✅ | ✅ |
...
| [Fuck Off as a Service](https://www.foaas.com) | Asks someone to fuck off | `No` | ✅ | `Unknown` |
...
| [Lanyard](https://github.com/Phineas/lanyard) | Retrieve your presence on Discord through an HTTP REST API or WebSocket | `No` | ✅ | ✅ |
| [Line](https://developers.line.biz/) | Line Login, Share on Line, Social Plugins and more | `OAuth` | ✅ | `Unknown` |
| [LinkedIn](https://docs.microsoft.com/en-us/linkedin/?context=linkedin/context) | The foundation of all digital integrations with LinkedIn | `OAuth` | ✅ | `Unknown` |
| [Meetup.com](https://www.meetup.com/api/guide) | Data about Meetups from Meetup.com | `apiKey` | ✅ | `Unknown` |
...
| [Revolt](https://developers.revolt.chat/api/) | Revolt open source Discord alternative | `apiKey` | ✅ | `Unknown` |
...
| [Telegraph](https://telegra.ph/api) | Create attractive blogs easily, to share | `apiKey` | ✅ | `Unknown` |
...
| [Trash Nothing](https://trashnothing.com/developer) | A freecycling community with thousands of free items posted every day | `OAuth` | ✅ | ✅ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [API-FOOTBALL](https://www.api-football.com/documentation-v3) | Get information about Football Leagues & Cups | `apiKey` | ✅ | ✅ |
| [ApiMedic](https://apimedic.com/) | ApiMedic offers a medical symptom checker API primarily for patients | `apiKey` | ✅ | `Unknown` |
| [balldontlie](https://www.balldontlie.io) | Balldontlie provides access to stats data from the NBA | `No` | ✅ | ✅ |
| [Canadian Football League (CFL)](http://api.cfl.ca/) | Official JSON API providing real-time league, team and player statistics about the CFL | `apiKey` | ✅ | ❌ |
| [City Bikes](https://api.citybik.es/v2/) | City Bikes around the world | `No` | ✅ | `Unknown` |
| [Cloudbet](https://www.cloudbet.com/api/) | Official Cloudbet API provides real-time sports odds and betting API to place bets programmatically | `apiKey` | ✅ | ✅ |
...
| [Ergast F1](http://ergast.com/mrd/) | F1 data from the beginning of the world championships in 1950 | `No` | ✅ | `Unknown` |
...
| [Football (Soccer) Videos](https://www.scorebat.com/video-api/) | Embed codes for goals and highlights from Premier League, Bundesliga, Serie A and many more | `No` | ✅ | ✅ |
| [Football Standings](https://github.com/azharimm/football-standings-api) | Display football standings e.g epl, la liga, serie a etc. The data is based on espn site | `No` | ✅ | ✅ |
...
| [NBA Stats](https://any-api.com/nba_com/nba_com/docs/API_Description) | Current and historical NBA Statistics | `No` | ✅ | `Unknown` |
| [NHL Records and Stats](https://gitlab.com/dword4/nhlapi) | NHL historical data and statistics | `No` | ✅ | `Unknown` |
| [Oddsmagnet](https://data.oddsmagnet.com) | Odds history from multiple UK bookmakers | `No` | ✅ | ✅ |
| [OpenLigaDB](https://www.openligadb.de) | Crowd sourced sports league results | `No` | ✅ | ✅ |
...
| [Sport Data](https://sportdataapi.com) | Get sports data from all over the world | `apiKey` | ✅ | `Unknown` |
| [Sport List & Data](https://developers.decathlon.com/products/sports) | List of and resources related to sports | `No` | ✅ | ✅ |
| [Sport Places](https://developers.decathlon.com/products/sport-places) | Crowd-source sports places around the world | `No` | ✅ | ❌ |
| [Sport Vision](https://developers.decathlon.com/products/sport-vision) | Identify sport, brands and gear in an image. Also does image sports captioning | `apiKey` | ✅ | ✅ |
...
| [Squiggle](https://api.squiggle.com.au) | Fixtures, results and predictions for Australian Football League matches | `No` | ✅ | ✅ |
| [Strava](https://strava.github.io/api/) | Connect with athletes, activities and more | `OAuth` | ✅ | `Unknown` |
| [SuredBits](https://suredbits.com/api/) | Query sports data, including teams, players, games, scores and statistics | `No` | ❌ | ❌ |
| [TheSportsDB](https://www.thesportsdb.com/api.php) | Crowd-Sourced Sports Data and Artwork | `apiKey` | ✅ | ✅ |
...
| [English Random Words](https://random-words-api.vercel.app/word) | Generate English Random Words with Pronunciation | `No` | ✅ | ❌ |
| [FakeJSON](https://fakejson.com) | Service to generate test and fake data | `apiKey` | ✅ | ✅ |
...
| [ItsThisForThat](https://itsthisforthat.com/api.php) | Generate Random startup ideas | `No` | ✅ | ❌ |
| [JSONPlaceholder](http://jsonplaceholder.typicode.com/) | Fake data for testing and prototyping | `No` | ❌ | `Unknown` |
...
| [QuickMocker](https://quickmocker.com) | API mocking tool to generate contextual, fake or random data | `No` | ✅ | ✅ |
| [Random Data](https://random-data-api.com) | Random data generator | `No` | ✅ | `Unknown` |
| [Randommer](https://randommer.io/randommer-api) | Random data generator | `apiKey` | ✅ | ✅ |
...
| [Spanish random names](https://random-names-api.herokuapp.com/public) | Generate spanish names (with gender) randomly | `No` | ✅ | `Unknown` |
| [Spanish random words](https://palabras-aleatorias-public-api.herokuapp.com) | Generate spanish words randomly | `No` | ✅ | `Unknown` |
| [This Person Does not Exist](https://thispersondoesnotexist.com) | Generates real-life faces of people who do not exist | `No` | ✅ | `Unknown` |
| [Toolcarton](https://testimonialapi.toolcarton.com/) | Generate random testimonial data | `No` | ✅ | `Unknown` |
| [UUID Generator](https://www.uuidtools.com/docs) | Generate UUIDs | `No` | ✅ | ❌ |
| [What The Commit](http://whatthecommit.com/index.txt) | Random commit message generator | `No` | ❌ | ✅ |
...
| [apilayer languagelayer](https://languagelayer.com/) | Language Detection JSON API supporting 173 languages | `OAuth` | ✅ | `Unknown` |
...
| [Cloudmersive Natural Language Processing](https://www.cloudmersive.com/nlp-api) | Natural language processing and text analysis | `apiKey` | ✅ | ✅ |
...
| [Hirak OCR](https://ocr.hirak.site/) | Image to text -text recognition- from image more than 100 language, accurate, unlimited requests | `apiKey` | ✅ | `Unknown` |
| [Hirak Translation](https://translate.hirak.site/) | Translate between 21 of most used languages, accurate, unlimited requests | `apiKey` | ✅ | `Unknown` |
| [Lecto Translation](https://rapidapi.com/lecto-lecto-default/api/lecto-translation/) | Translation API with free tier and reasonable prices | `apiKey` | ✅ | ✅ |
...
| [Sentiment Analysis](https://www.meaningcloud.com/developer/sentiment-analysis) | Multilingual sentiment analysis of texts from different sources | `apiKey` | ✅ | ✅ |
| [Tisane](https://tisane.ai/) | Text Analytics with focus on detection of abusive content and law enforcement applications | `OAuth` | ✅ | ✅ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [Aftership](https://developers.aftership.com/reference/quick-start) | API to update, manage and track shipment efficiently | `apiKey` | ✅ | ✅ |
...
| [Pixela](https://pixe.la) | API for recording and tracking habits or effort, routines | `X-Mashape-Key` | ✅ | ✅ |
| [PostalPinCode](http://www.postalpincode.in/Api-Details) | API for getting Pincode details in India | `No` | ✅ | `Unknown` |
| [Postmon](http://postmon.com.br) | An API to query Brazilian ZIP codes and orders easily, quickly and free | `No` | ❌ | `Unknown` |
| [PostNord](https://developer.postnord.com/api) | Provides information about parcels in transport for Sweden and Denmark | `apiKey` | ❌ | `Unknown` |
| [UPS](https://www.ups.com/upsdeveloperkit) | Shipment and Address information | `apiKey` | ✅ | `Unknown` |
| [WeCanTrack](https://docs.wecantrack.com) | Automatically place subids in affiliate links to attribute affiliate conversions to click data | `apiKey` | ✅ | ✅ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [ADS-B Exchange](https://www.adsbexchange.com/data/) | Access real-time and historical data of any and all airborne aircraft | `No` | ✅ | `Unknown` |
| [airportsapi](https://airport-web.appspot.com/api/docs/) | Get name and website-URL for airports by ICAO code | `No` | ✅ | `Unknown` |
| [AIS Hub](http://www.aishub.net/api) | Real-time data of any marine and inland vessel equipped with AIS tracking system | `apiKey` | ❌ | `Unknown` |
| [Amadeus for Developers](https://developers.amadeus.com/self-service) | Travel Search - Limited usage | `OAuth` | ✅ | `Unknown` |
| [apilayer aviationstack](https://aviationstack.com/) | Real-time Flight Status & Global Aviation Data API | `OAuth` | ✅ | `Unknown` |
| [AviationAPI](https://docs.aviationapi.com) | FAA Aeronautical Charts and Publications, Airport Information, and Airport Weather | `No` | ✅ | ❌ |
| [AZ511](https://www.az511.com/developers/doc) | Access traffic data from the ADOT API | `apiKey` | ✅ | `Unknown` |
| [Bay Area Rapid Transit](http://api.bart.gov) | Stations and predicted arrivals for BART | `apiKey` | ❌ | `Unknown` |
| [BC Ferries](https://www.bcferriesapi.ca) | Sailing times and capacities for BC Ferries | `No` | ✅ | ✅ |
| [BIC-Boxtech](https://docs.bic-boxtech.org/) | Container technical detail for the global container fleet | `OAuth` | ✅ | `Unknown` |
| [BlaBlaCar](https://dev.blablacar.com) | Search car sharing trips | `apiKey` | ✅ | `Unknown` |
...
| [Compare Flight Prices](https://rapidapi.com/obryan-software-obryan-software-default/api/compare-flight-prices/) | API for comparing flight prices across platforms | `apiKey` | ✅ | `Unknown` |
| [CTS](https://api.cts-strasbourg.eu/) | CTS Realtime API | `apiKey` | ✅ | ✅ |
...
| [Icelandic APIs](http://docs.apis.is/) | Open APIs that deliver services in or regarding Iceland | `No` | ✅ | `Unknown` |
| [Impala Hotel Bookings](https://docs.impala.travel/docs/booking-api/) | Hotel content, rates and room bookings | `apiKey` | ✅ | ❌ |
| [Izi](http://api-docs.izi.travel/) | Audio guide for travellers | `apiKey` | ✅ | `Unknown` |
...
| [Metro Lisboa](http://app.metrolisboa.pt/status/getLinhas.php) | Delays in subway lines | `No` | ❌ | ❌ |
| [Navitia](https://doc.navitia.io/) | The open API for building cool stuff with transport data | `apiKey` | ✅ | `Unknown` |
| [Open Charge Map](https://openchargemap.org/site/develop/api) | Global public registry of electric vehicle charging locations | `apiKey` | ✅ | ✅ |
| [OpenSky Network](https://opensky-network.org/apidoc/index.html) | Free real-time ADS-B aviation data | `No` | ✅ | `Unknown` |
...
| [Tankerkoenig](https://creativecommons.tankerkoenig.de/swagger/) | German realtime gas/diesel prices | `apiKey` | ✅ | ✅ |
...
| [Transport for Belgium](https://docs.irail.be/) | The iRail API is a third-party API for Belgian public transport by train | `No` | ✅ | ✅ |
| [Transport for Berlin, Germany](https://github.com/derhuerst/vbb-rest/blob/3/docs/index.md) | Third-party VBB API | `No` | ✅ | `Unknown` |
...
| [Transport for Chicago, US](http://www.transitchicago.com/developers/) | Chicago Transit Authority (CTA) | `apiKey` | ❌ | `Unknown` |
...
| [Transport for Finland](https://digitransit.fi/en/developers/) | Finnish transport API | `No` | ✅ | `Unknown` |
| [Transport for Germany](http://data.deutschebahn.com/dataset/api-fahrplan) | Deutsche Bahn (DB) API | `apiKey` | ❌ | `Unknown` |
| [Transport for Grenoble, France](https://www.mobilites-m.fr/pages/opendata/OpenDataApi.html) | Grenoble public transport | `No` | ❌ | ❌ |
| [Transport for Hessen, Germany](https://opendata.rmv.de/site/start.html) | RMV API (Public Transport in Hessen) | `No` | ✅ | `Unknown` |
| [Transport for Honolulu, US](http://hea.thebus.org/api_info.asp) | Honolulu Transportation Information | `apiKey` | ❌ | `Unknown` |
...
| [Transport for Manchester, England](https://developer.tfgm.com/) | TfGM transport network data | `apiKey` | ✅ | ❌ |
...
| [Transport for Sao Paulo, Brazil](http://www.sptrans.com.br/desenvolvedores/api-do-olho-vivo-guia-de-referencia/documentacao-api/) | SPTrans | `OAuth` | ❌ | `Unknown` |
| [Transport for Spain](https://data.renfe.com/api/1/util/snippet/api_info.html?resource_id=a2368cff-1562-4dde-8466-9635ea3a572a) | Public trains of Spain | `No` | ✅ | `Unknown` |
...
| [Transport for The Netherlands](http://www.ns.nl/reisinformatie/ns-api) | NS, only trains | `apiKey` | ❌ | `Unknown` |
...
| [transport.rest](https://transport.rest) | Community maintained, developer-friendly public transport API | `No` | ✅ | ✅ |
...
| [Uber](https://developer.uber.com/products) | Uber ride requests and price estimation | `OAuth` | ✅ | ✅ |
| [Velib metropolis, Paris, France](https://www.velib-metropole.fr/donnees-open-data-gbfs-du-service-velib-metropole) | Velib Open Data API | `No` | ✅ | ❌ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [1pt](https://github.com/1pt-co/api/blob/main/README.md) | A simple URL shortener | `No` | ✅ | ✅ |
| [Bitly](http://dev.bitly.com/get_started.html) | URL shortener and link management | `OAuth` | ✅ | `Unknown` |
| [CleanURI](https://cleanuri.com/docs) | URL shortener service | `No` | ✅ | ✅ |
| [ClickMeter](https://support.clickmeter.com/hc/en-us/categories/201474986) | Monitor, compare and optimize your marketing links | `apiKey` | ✅ | `Unknown` |
| [Clico](https://cli.com/swagger-ui/index.html?configUrl=/v3/api-docs/swagger-config) | URL shortener service | `apiKey` | ✅ | `Unknown` |
| [Cutt.ly](https://cutt.ly/api-documentation/cuttly-links-api) | URL shortener service | `apiKey` | ✅ | `Unknown` |
| [Drivet URL Shortener](https://wiki.drivet.xyz/en/url-shortener/add-links) | Shorten a long URL easily and fast | `No` | ✅ | `Unknown` |
...
| [Git.io](https://github.blog/2011-11-10-git-io-github-url-shortener/) | Git.io URL shortener | `No` | ✅ | `Unknown` |
| [GoTiny](https://github.com/robvanbakel/gotiny-api) | A lightweight URL shortener, focused on ease-of-use for the developer and end-user | `No` | ✅ | ✅ |
| [Kutt](https://docs.kutt.it/) | Free Modern URL Shortener | `apiKey` | ✅ | ✅ |
| [Mgnet.me](http://mgnet.me/api.html) | Torrent URL shorten API | `No` | ✅ | ❌ |
| [owo](https://owo.vc/api) | A simple link obfuscator/shortener | `No` | ✅ | `Unknown` |
| [Rebrandly](https://developers.rebrandly.com/v1/docs) | Custom URL shortener for sharing branded links | `apiKey` | ✅ | `Unknown` |
| [Short Link](https://github.com/FayasNoushad/Short-Link-API) | Short URLs support so many domains | `No` | ✅ | `Unknown` |
| [Shrtcode](https://shrtco.de/docs) | URl Shortener with multiple Domains | `No` | ✅ | ✅ |
| [Shrtlnk](https://shrtlnk.dev/developer) | Simple and efficient short link creation | `apiKey` | ✅ | ✅ |
| [TinyURL](https://tinyurl.com/app/dev) | Shorten long URLs | `apiKey` | ✅ | ❌ |
| [UrlBae](https://urlbae.com/developers) | Simple and efficient short link creation | `apiKey` | ✅ | ✅ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [Brazilian Vehicles and Prices](https://deividfortuna.github.io/fipe/) | Vehicles information from Fundação Instituto de Pesquisas Econômicas - Fipe | `No` | ✅ | ❌ |
...
| [Kelley Blue Book](http://developer.kbb.com/#!/data/1-Default) | Vehicle info, pricing, configuration, plus much more | `apiKey` | ✅ | ❌ |
| [Mercedes-Benz](https://developer.mercedes-benz.com/apis) | Telematics data, remotely access vehicle functions, car configurator, locate service dealers | `apiKey` | ✅ | ❌ |
| [NHTSA](https://vpic.nhtsa.dot.gov/api/) | NHTSA Product Information Catalog and Vehicle Listing | `No` | ✅ | `Unknown` |
| [Smartcar](https://smartcar.com/docs/) | Lock and unlock vehicles and get data like odometer reading and location. Works on most new cars | `OAuth` | ✅ | ✅ |
...
| [Bob's Burgers](https://bobs-burgers-api-ui.herokuapp.com) | Bob's Burgers API | `No` | ✅ | ✅ |
| [Breaking Bad](https://breakingbadapi.com/documentation) | Breaking Bad API | `No` | ✅ | `Unknown` |
...
| [Catch The Show](https://catchtheshow.herokuapp.com/api/documentation) | REST API for next-episode.net | `No` | ✅ | `Unknown` |
...
| [Dune](https://github.com/ywalia01/dune-api) | A simple API which provides you with book, character, movie and quotes JSON data | `No` | ✅ | ✅ |
| [Final Space](https://finalspaceapi.com/docs/) | Final Space API | `No` | ✅ | ✅ |
| [Game of Thrones Quotes](https://gameofthronesquotes.xyz/) | Some Game of Thrones quotes | `No` | ✅ | `Unknown` |
| [Harry Potter Charactes](https://hp-api.herokuapp.com/) | Harry Potter Characters Data with with imagery | `No` | ✅ | `Unknown` |
| [IMDb-API](https://imdb-api.com/) | API for receiving movie, serial and cast information | `apiKey` | ✅ | `Unknown` |
| [IMDbOT](https://github.com/SpEcHiDe/IMDbOT) | Unofficial IMDb Movie / Series Information | `No` | ✅ | ✅ |
| [JSON2Video](https://json2video.com) | Create and edit videos programmatically: watermarks,resizing,slideshows,voice-over,text animations | `apiKey` | ✅ | ❌ |
| [Lucifer Quotes](https://github.com/shadowoff09/lucifer-quotes) | Returns Lucifer quotes | `No` | ✅ | `Unknown` |
| [MCU Countdown](https://github.com/DiljotSG/MCU-Countdown) | A Countdown to the next MCU Film | `No` | ✅ | ✅ |
| [Motivational Quotes](https://nodejs-quoteapp.herokuapp.com/) | Random Motivational Quotes | `No` | ✅ | `Unknown` |
| [Movie Quote](https://github.com/F4R4N/movie-quote/) | Random Movie and Series Quotes | `No` | ✅ | ✅ |
| [Open Movie Database](http://www.omdbapi.com/) | Movie information | `apiKey` | ✅ | `Unknown` |
| [Owen Wilson Wow](https://owen-wilson-wow-api.herokuapp.com) | API for actor Owen Wilson's "wow" exclamations in movies | `No` | ✅ | ✅ |
...
| [STAPI](http://stapi.co) | Information on all things Star Trek | `No` | ❌ | ❌ |
| [Stranger Things Quotes](https://github.com/shadowoff09/strangerthings-quotes) | Returns Stranger Things quotes | `No` | ✅ | `Unknown` |
| [Stream](https://api.stream.cz/graphiql) | Czech internet television, films, series and online videos for free | `No` | ✅ | ❌ |
| [Stromberg Quotes](https://www.stromberg-api.de/) | Returns Stromberg quotes and more | `No` | ✅ | `Unknown` |
| [SWAPI](https://swapi.dev/) | All the Star Wars data you've ever wanted | `No` | ✅ | ✅ |
| [SWAPI](https://www.swapi.tech) | All things Star Wars | `No` | ✅ | ✅ |
...
| [The Vampire Diaries](https://vampire-diaries-api.netlify.app/) | TV Show Data | `apiKey` | ✅ | ✅ |
...
| [TrailerAddict](https://www.traileraddict.com/trailerapi) | Easily embed trailers from TrailerAddict | `apiKey` | ❌ | `Unknown` |
| [Trakt](https://trakt.docs.apiary.io/) | Movie and TV Data | `apiKey` | ✅ | ✅ |
...
| [uNoGS](https://rapidapi.com/unogs/api/unogsng) | Unofficial Netflix Online Global Search, Search all netflix regions in one place | `apiKey` | ✅ | ✅ |
...
| [Web Series Quotes Generator](https://github.com/yogeshwaran01/web-series-quotes) | API generates various Web Series Quote Images | `No` | ✅ | ✅ |
...
| API | Description | Auth | HTTPS | CORS |
| :--- | :--- | :---: | :---: | :---: |
| [Weatherstack](https://weatherstack.com/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers) | Real-Time & Historical World Weather Data API | `apiKey` | ✅ | `Unknown` |
...
| [HG Weather](https://hgbrasil.com/status/weather) | Provides weather forecast data for cities in Brazil | `apiKey` | ✅ | ✅ |
...
| [MetaWeather](https://www.metaweather.com/api/) | Weather | `No` | ✅ | ❌ |
| [Meteorologisk Institutt](https://api.met.no/weatherapi/documentation) | Weather and climate data | `User-Agent` | ✅ | `Unknown` |
| [Micro Weather](https://m3o.com/weather/api) | Real time weather forecasts and historic data | `apiKey` | ✅ | `Unknown` |
| [ODWeather](http://api.oceandrivers.com/static/docs.html) | Weather and weather webcams | `No` | ❌ | `Unknown` |
| [Oikolab](https://docs.oikolab.com) | 70+ years of global, hourly historical and forecast weather data from NOAA and ECMWF | `apiKey` | ✅ | ✅ |
| [Open-Meteo](https://open-meteo.com/) | Global weather forecast API for non-commercial use | `No` | ✅ | ✅ |
| [openSenseMap](https://api.opensensemap.org/) | Data from Personal Weather Stations called senseBoxes | `No` | ✅ | ✅ |
...
| [QWeather](https://dev.qweather.com/en/) | Location-based weather data | `apiKey` | ✅ | ✅ |
| [RainViewer](https://www.rainviewer.com/api.html) | Radar data collected from different websites across the Internet | `No` | ✅ | `Unknown` |
| [Storm Glass](https://stormglass.io/) | Global marine weather from multiple sources | `apiKey` | ✅ | ✅ |
...
| [Visual Crossing](https://www.visualcrossing.com/weather-api) | Global historical and weather forecast data | `apiKey` | ✅ | ✅ |
| [weather-api](https://github.com/robertoduessmann/weather-api) | A RESTful free API to check the weather | `No` | ✅ | ❌ |
| [WeatherAPI](https://www.weatherapi.com/) | Weather API with other stuff like Astronomy and Geolocation API | `apiKey` | ✅ | ✅ |
| [Weatherbit](https://www.weatherbit.io/api) | Weather | `apiKey` | ✅ | `Unknown` |
| [Yandex.Weather](https://yandex.com/dev/weather/) | Assesses weather condition in specific locations | `apiKey` | ✅ | ❌ |
...
## 📜 License
This project is licensed under the [MIT License](LICENSE) © 2022 public-apis.
